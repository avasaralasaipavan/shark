export const dict = {
  ...
  "desktop.updater.none.message": "Веќе ја користите најновата верзија на Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзијата {{version}} од Shark е преземена, дали сакате да ја инсталирате и повторно да ја стартувате?",
