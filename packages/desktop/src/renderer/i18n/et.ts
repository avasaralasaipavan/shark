export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Shark uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Shark'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
