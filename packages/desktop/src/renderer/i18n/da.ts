export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Shark er blevet downloadet. Vil du installere den og genstarte?",
