export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Shark",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Shark",
  "desktop.recovery.terminated": "La fenêtre Shark s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Shark ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Shark",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Shark est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Shark",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Shark.",
  ...
  "dialog.server.description": "Changez le serveur Shark auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Shark dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Shark dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Shark dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Shark dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Shark puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Shark n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Shark.",
  ...
  "help.tabs.introduction": "Shark Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Shark ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Shark",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Shark ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Shark inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Shark dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Shark",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Shark sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Shark suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Shark.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Shark",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Shark.",
