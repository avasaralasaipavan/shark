export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Shark",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Shark",
  "desktop.recovery.terminated": "Okno Shark zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Shark nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Shark",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Shark została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Shark",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Shark.",
  ...
  "dialog.server.description": "Przełącz serwer Shark, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Shark w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Shark w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Shark w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Shark w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Shark będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Shark nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Shark.",
  ...
  "help.tabs.introduction": "Shark Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Shark ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Shark",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Shark nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Shark zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Shark wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Shark",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Shark na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Shark ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Shark.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Shark",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Shark.",
