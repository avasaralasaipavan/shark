export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Shark",
  ...
  "desktop.recovery.loadFailed": "Shark gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Shark ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Shark tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Shark gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Shark selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Shark",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Shark.",
  ...
  "dialog.server.description": "Tukar pelayan Shark yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Shark dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Shark dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Shark dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Shark dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Shark boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Shark tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Shark.",
  ...
  "help.tabs.introduction": "Shark Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Shark ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Shark",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Shark belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shark merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Shark dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Shark",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Shark pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Shark mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Shark.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Shark dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Shark.",
