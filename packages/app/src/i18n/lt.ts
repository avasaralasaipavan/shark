...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Shark įkelti nepavyko",
  "Shark langas netikėtai užsidarė",
  "Shark neatsako",
  ...
  "Shark įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Shark neįdiegtas distributyve {{distro}}",
  "Shark naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Shark modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Shark.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Shark serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Shark {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Shark {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Shark {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Shark į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Shark galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Shark nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Shark.",
  ...
  "help.tabs.introduction": "Shark Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Shark ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Shark komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Shark dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Shark apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Shark darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Shark serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Shark ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Shark atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Shark seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Shark temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Shark",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Shark versiją.",
