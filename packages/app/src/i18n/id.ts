export const dict = {
  ...
  "desktop.recovery.loadFailed": "Shark gagal dimuat",
  "desktop.recovery.terminated": "Jendela Shark berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Shark tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Shark gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Shark selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Shark",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Shark.",
  ...
  "dialog.server.description": "Ganti server Shark mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Shark di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Shark di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Shark di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Shark di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Shark dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Shark tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Shark.",
  ...
  "help.tabs.introduction": "Shark Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Shark ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Shark",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Shark belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shark menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Shark di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Shark",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Shark di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Shark mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Shark diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Shark.",
