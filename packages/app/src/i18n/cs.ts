export const dict = {
  ...
  "desktop.menu.documentation": "Shark Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Shark",
  ...
  "desktop.recovery.loadFailed": "Shark se nepodařilo načíst",
  "desktop.recovery.terminated": "Shark okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Shark nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Shark instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Shark aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Shark.",
  ...
  "dialog.server.description": "Přepněte, ke kterému Shark serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Shark v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Shark v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Shark v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Shark do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Shark může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Shark nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Shark.",
  ...
  "help.tabs.introduction": "Shark Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Shark ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Shark",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Shark zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shark obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Shark uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Shark",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Shark na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Shark následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Shark.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Shark",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Shark.",
