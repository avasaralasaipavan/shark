export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Shark is gedownload. Wil je deze installeren en Shark opnieuw starten?",
