export const dict = {
  ...
  "desktop.updater.none.message": "Χρησιμοποιείτε ήδη την πιο πρόσφατη έκδοση του Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Έχει γίνει λήψη της έκδοσης {{version}} του Shark. Θέλετε να την εγκαταστήσετε και να επανεκκινήσετε την εφαρμογή;",
