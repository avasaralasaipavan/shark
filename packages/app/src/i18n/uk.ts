export const dict = {
  ...
  "desktop.menu.documentation": "Документація Shark",
  ...
  "desktop.menu.ariaLabel": "Меню Shark",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Shark",
  "desktop.recovery.terminated": "Роботу вікна Shark несподівано завершено",
  "desktop.recovery.unresponsive": "Shark не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити Shark",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Shark завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Shark",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Shark.",
  ...
  "dialog.server.description": "Перемкніть сервер Shark, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка Shark у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення Shark у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть Shark у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть Shark у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Shark потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Shark не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Shark.",
  ...
  "help.tabs.introduction": "Shark Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Shark ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Shark",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Shark ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shark містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Shark всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Shark",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Shark на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Shark використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Shark.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Shark",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Shark.",
