export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Shark Data",
  "app.description":
    "Esplora l'utilizzo di Shark nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Shark Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Shark su GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Prova Shark",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Shark.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Shark per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Shark Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Shark, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Shark.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Shark",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Shark",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Shark negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Shark Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Shark, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Shark appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Shark della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Shark della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Shark nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Shark, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Shark.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Shark nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Shark nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Shark.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica Shark corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token Shark.",
