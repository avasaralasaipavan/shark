export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Shark",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Shark.",
  ...
  "dialog.server.description": "Skift hvilken Shark-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Shark i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Shark i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Shark i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Shark kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Shark kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Shark igen.",
  ...
  "toast.update.description": "En ny version af Shark ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Shark-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Shark understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Shark inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Shark-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Shark",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Shark ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Shark skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Shark starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Shark.",
  ...
  "desktop.recovery.loadFailed": "Shark kunne ikke indlæses",
  "desktop.recovery.terminated": "Shark-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Shark mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Shark er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Shark Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
