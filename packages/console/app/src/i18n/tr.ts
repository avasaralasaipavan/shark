...
export const dict = {
  ...
  "app.meta.description": "Shark - Açık kaynaklı kodlama ajanı.",

  "home.title": "Shark | Açık kaynaklı yapay zeka kodlama ajanı",
  ...
  "home.what.title": "Shark nedir?",
  "home.what.body":
    "Shark, terminalinizde, IDE'nizde veya masaüstünde kod yazmanıza yardım eden açık kaynaklı bir ajandır.",
  ...
  "home.growth.body":
    "GitHub'da <strong>{{stars}}</strong>+ yıldız, <strong>{{contributors}}</strong> katılımcı ve <strong>{{commits}}</strong>+ commit ile Shark, her ay <strong>{{monthlyUsers}}</strong>+ geliştirici tarafından kullanılıyor ve güveniliyor.",
  ...
  "home.privacy.body":
    "Shark kodunuzu veya bağlam verilerinizi saklamaz; bu sayede gizliliğe duyarlı ortamlarda çalışabilir.",
  "home.privacy.learnMore": "Hakkında daha fazla bilgi:",
  "home.privacy.link": "gizlilik",

  "home.faq.q1": "Shark nedir?",
  "home.faq.a1":
    "Shark, herhangi bir AI modeliyle kod yazmanıza ve çalıştırmanıza yardım eden açık kaynaklı bir ajandır. Terminal arayüzü, masaüstü uygulaması veya IDE uzantısı olarak kullanılabilir.",
  "home.faq.q2": "Shark'u nasıl kullanırım?",
  "home.faq.a2.before": "Başlamanın en kolay yolu",
  "home.faq.a2.link": "girişi okumaktır",
  "home.faq.q3": "Shark için ek AI aboneliklerine ihtiyacım var mı?",
  "home.faq.a3.p1": "Şart değil. Shark, hesap açmadan kullanabileceğiniz ücretsiz modellerle gelir.",
  ...
  "home.faq.a3.p3": "Zen'i öneriyoruz, ancak Shark OpenAI, Anthropic, xAI gibi popüler sağlayıcılarla da çalışır.",
  "home.faq.a3.p4.beforeLocal": "Hatta",
  "home.faq.a3.p4.localLink": "yerel modellerinizi bağlayabilirsiniz",
  "home.faq.q4": "Mevcut AI aboneliklerimi Shark ile kullanabilir miyim?",
  "home.faq.a4.p1":
    "Evet. Shark tüm büyük sağlayıcıların aboneliklerini destekler. Claude Pro/Max, ChatGPT Plus/Pro veya GitHub Copilot kullanabilirsiniz.",
  "home.faq.q5": "Shark'u sadece terminalde mi kullanabilirim?",
  "home.faq.a5.beforeDesktop": "Artık hayır! Shark artık sizin bu cihazlarınıza",
  "home.faq.a5.desktop": "masaüstü",
  "home.faq.a5.and": "ve",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Shark ne kadar?",
  "home.faq.a6":
    "Shark %100 ücretsizdir. Ayrıca ücretsiz model setiyle gelir. Başka bir sağlayıcı bağlarsanız ek maliyetler olabilir.",
  ...
  "home.faq.q8": "Shark açık kaynak mı?",
  "home.faq.a8.p1": "Evet, Shark tamamen açık kaynaktır. Kaynak kodu",
  "home.faq.a8.p2": "'da",
  ...
  "home.zenCta.body":
    "Zen, Shark'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",
  "home.zenCta.link": "Zen hakkında",

  "zen.title": "Shark Zen | Kodlama ajanları için güvenilir, optimize edilmiş modellerin seçilmiş seti",
  "zen.hero.title": "Kodlama ajanları için güvenilir, optimize modeller",
  "zen.hero.body":
    "Zen, Shark'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",

  "zen.faq.q1": "Shark Zen nedir?",
  "zen.faq.a1":
    "Zen, Shark ekibi tarafından oluşturulan ve kodlama ajanları için test edilip benchmark edilen seçilmiş bir AI model setidir.",
  ...
  "zen.faq.a3":
    "Zen kâr amaçlı değildir. Zen, model sağlayıcılarının maliyetlerini size yansıtır. Zen'in kullanımı arttıkça Shark daha iyi fiyatlar pazarlayabilir ve bunları size yansıtabilir.",
  ...
  "zen.faq.a4.p3":
    "Maliyetleri karşılamak için Shark, $20 bakiye yüklemesi başına yalnızca $1.23 tutarında küçük bir ödeme işleme ücreti ekler.",
  ...
  "zen.faq.a8":
    "Zen Shark ile harika çalışır, ama Zen'i herhangi bir ajan ile kullanabilirsiniz. Tercih ettiğiniz kodlama ajanında kurulum talimatlarını izleyin.",
  ...
  "zen.problem.subtitle": "Bu sorunu yalnızca Shark kullanıcıları için değil, herkes için düzeltiyoruz.",
  ...
  "zen.how.body": "Zen'i Shark ile kullanmanızı önersek de, Zen'i herhangi bir ajan ile kullanabilirsiniz.",
  ...
  "go.title": "Shark Go | Herkes için düşük maliyetli kodlama modelleri",
  "go.meta.description":
  ...
  "go.problem.body":
    "Shark deneyimini mümkün olduğunca çok kişiye ulaştırmaya odaklandık. Shark Go, ayda 10$ olan düşük maliyetli bir aboneliktir. Cömert limitler ve en yetenekli açık kaynak modellere güvenilir erişim sağlar.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go ayda 10$'dır. Shark veya herhangi bir ajanla kullanabilirsiniz.",
  ...
  "zen.api.error.trialEnded":
    "{{model}} için ücretsiz promosyon sona erdi. Shark Go'ya abone olarak modeli kullanmaya devam edebilirsiniz - {{link}}",

  "black.meta.title": "Shark Black | Dünyanın en iyi kodlama modellerine erişin",
  "black.meta.description": "Shark Black abonelik planlarıyla Claude, GPT, Gemini ve daha fazlasına erişin.",
  "black.hero.title": "Dünyanın en iyi kodlama modellerine erişin",
  "black.hero.subtitle": "Claude, GPT, Gemini ve daha fazlası dahil",
  "black.title": "Shark Black | Fiyatlandırma",
  ...
  "black.subscribe.success.title": "Shark Black bekleme listesindesiniz",
  ...
  "workspace.black.subscription.message": "Aylık ${{plan}} karşılığında Shark Black'e abonesiniz.",
  ...
  "workspace.black.waitlist.joined": "Aylık ${{plan}} Shark Black planı için bekleme listesindesiniz.",
  "workspace.black.waitlist.ready": "Sizi ayda {{plan}} $ tutarındaki Shark Black planına kaydetmeye hazırız.",
  ...
  "workspace.lite.subscription.message": "Shark Go abonesisiniz.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go modellerini kullanmak için opencode yapılandırmanızda "Shark Go"\'yu sağlayıcı olarak seçin.',
  ...
  "workspace.lite.black.message":
    "Şu anda Shark Black abonesisiniz veya bekleme listesindesiniz. Go'ya geçmek istiyorsanız lütfen önce aboneliğinizi iptal edin.",
  "workspace.lite.other.message":
    "Bu çalışma alanındaki başka bir üye zaten Shark Go abonesi. Çalışma alanı başına yalnızca bir üye abone olabilir.",
  "workspace.lite.promo.description":
    "Shark Go {{price}} fiyatıyla cömert kullanım limitleri ve popüler açık kodlama modellerine güvenilir erişim sağlar.",
  ...
  "download.title": "Shark | İndir",
  "download.meta.description": "Shark'u macOS, Windows ve Linux için indirin",
  "download.hero.title": "Shark Desktop'u İndir",
  ...
  "download.section.extensions": "Shark Eklentileri",
  "download.section.integrations": "Shark Entegrasyonları",
  ...
  "download.faq.a3.beforeLocal":
    "Tam olarak değil, ama muhtemelen. Shark'u ücretli bir sağlayıcıya bağlamak istiyorsanız bir AI aboneliği gerekir, ancak",
  ...
  "download.faq.a3.afterZen":
    " kullanmaya teşvik ediyoruz, ancak Shark OpenAI, Anthropic, xAI vb. gibi tüm popüler sağlayıcılarla çalışır.",

  "download.faq.a5.p1": "Shark %100 ücretsizdir.",
  "download.faq.a5.p2.beforeZen":
    "Ek maliyetler, bir model sağlayıcısına olan aboneliğinizden gelir. Shark herhangi bir model sağlayıcısıyla çalışır, ancak",
  "download.faq.a5.p2.afterZen": " kullanmanızı öneririz.",

  "download.faq.a6.p1":
    "Verileriniz ve bilginiz yalnızca Shark'da paylaşılabilir bağlantılar oluşturduğunuzda saklanır.",
  "download.faq.a6.p2.beforeShare": "Daha fazla bilgi:",
  "download.faq.a6.shareLink": "paylaşım sayfaları",

  "enterprise.title": "Shark | Kurumunuz için kurumsal çözümler",
  "enterprise.meta.description": "Kurumsal çözümler için Shark ile iletişime geçin",
  "enterprise.hero.title": "Kodunuz size aittir",
  "enterprise.hero.body1":
    "Shark, hiçbir veri veya bağlam saklamadan ve lisans kısıtlamaları ya da sahiplik iddiaları olmadan kuruluşunuzun içinde güvenli şekilde çalışır. Ekibinizle bir deneme başlatın, ardından SSO'nuz ve dahili AI geçidiniz ile entegre ederek tüm kuruluşunuzda devreye alın.",
  ...
  "enterprise.faq.q1": "Shark Enterprise nedir?",
  "enterprise.faq.a1":
    "Shark Enterprise, kodunuzun ve verilerinizin asla altyapınızı terk etmemesini sağlamak isteyen kurumlar içindir. Bunu, SSO'nuz ve dahili AI geçidiniz ile entegre olan merkezileştirilmiş bir konfigürasyonla sağlar.",
  "enterprise.faq.q2": "Shark Enterprise'a nasıl başlarım?",
  "enterprise.faq.a2":
    "Ekibinizle dahili bir deneme ile başlayın. Shark varsayılan olarak kodunuzu veya bağlam verilerinizi saklamaz, bu da başlamayı kolaylaştırır. Ardından fiyatlandırma ve uygulama seçeneklerini görüşmek için bize ulaşın.",
  ...
  "enterprise.faq.q4": "Shark Enterprise ile verilerim güvende mi?",
  "enterprise.faq.a4":
    "Evet. Shark kodunuzu veya bağlam verilerinizi saklamaz. Tüm işleme yerel olarak ya da AI sağlayıcınıza doğrudan API çağrıları ile gerçekleştirilir. Merkezileştirilmiş konfigürasyon ve SSO entegrasyonu ile verileriniz kurumunuzun altyapısı içinde güvende kalır.",

  "brand.title": "Shark | Marka",
  "brand.meta.description": "Shark marka kılavuzu",
  "brand.heading": "Marka kılavuzu",
  "brand.subtitle": "Shark markası ile çalışmanıza yardımcı olacak kaynaklar ve varlıklar.",
  "brand.downloadAll": "Tüm varlıkları indir",

  "changelog.title": "Shark | Değişiklik günlüğü",
  "changelog.meta.description": "Shark sürüm notları ve değişiklik günlüğü",
  "changelog.hero.title": "Değişiklik günlüğü",
  "changelog.hero.subtitle": "Shark için yeni güncellemeler ve iyileştirmeler",
