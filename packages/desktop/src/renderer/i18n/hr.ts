export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Shark. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
