export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด Shark ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง Shark หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "Shark ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installOpencode": "การติดตั้ง Shark ล้มเหลว",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ไม่ได้ติดตั้ง Shark ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต Shark เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Shark",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Shark",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Shark",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Shark",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Shark ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ Shark...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ Shark ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต Shark...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต Shark ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต Shark ใน {{distro}}",
  "wsl.onboarding.updateOpencode": "อัปเดต Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.opencodeReady": "Shark พร้อมใช้งานแล้ว",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง Shark ใน {{distro}}",
  "wsl.onboarding.installOpencode": "ติดตั้ง Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง Shark",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Shark จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Shark ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Shark อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ Shark Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Shark ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Shark",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Shark ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Shark รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Shark ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Shark",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ Shark บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Shark ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ Shark",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Shark เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Shark เวอร์ชันล่าสุด",
