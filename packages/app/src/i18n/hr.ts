...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Shark se nije uspio učitati",
  "Prozor aplikacije Shark neočekivano je zatvoren",
  "Shark ne reagira",
  ...
  "Instalacija aplikacije Shark nije uspjela",
  ...
  "Shark nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Shark je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Shark",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Shark.",
  ...
  "dialog.server.description": "Promijenite na koji se Shark poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Shark u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Shark u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Shark u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Shark u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Shark",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Shark može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Shark nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Shark.",
  ...
  "help.tabs.introduction": "Radna površina Shark sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Shark ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Shark timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Shark još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Shark uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Shark Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Shark poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Shark",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Shark izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Shark slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Shark tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Shark pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Shark.",
