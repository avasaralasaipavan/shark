export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Shark",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Shark.",
  ...
  "dialog.server.description": "Cambia il server Shark a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Shark in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Shark in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Shark in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Shark in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Shark possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Shark non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Shark.",
  ...
  "help.tabs.introduction": "Shark Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Shark ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Shark",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Shark non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shark include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Shark all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Shark",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Shark sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Shark segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Shark.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Shark",
  ...
  "settings.updates.toast.latest.title": "Shark è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Shark.",
  ...
  "desktop.menu.documentation": "Documentazione di Shark",
  ...
  "desktop.menu.ariaLabel": "Menu Shark",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Shark",
  "desktop.recovery.terminated": "La finestra di Shark si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Shark non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Shark non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Shark è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
