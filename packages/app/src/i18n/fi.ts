export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "dialog.server.description": "Vaihda Shark-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.updateOpencodeIn": "Päivitä Shark jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Shark jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Shark",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Shark voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Shark ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Shark uudelleen.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Shark-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Shark ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Shark sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Shark-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Shark näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Shark järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Shark käynnistyy",
  ...
  "desktop.menu.documentation": "Shark-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Shark-valikko",
  ...
  "desktop.recovery.terminated": "Shark-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Shark ei vastaa",
  ...
  "help.tabs.introduction": "Shark Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
