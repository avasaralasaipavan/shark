export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | Shark Data",
  "app.description":
    "Explora el uso de Shark en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de Shark Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a Shark en GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Probar Shark",
  ...
  "footer.homeAria": "Inicio de Shark",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en Shark.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de Shark por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | Shark Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en Shark, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de Shark.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en Shark",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de Shark",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de Shark durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | Shark Data",
  "model.description":
    "Consulta datos de uso de {{model}} en Shark, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de Shark aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de Shark de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de Shark de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de Shark en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de Shark, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de Shark.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de Shark durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de Shark durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de Shark.",
  ...
  "model.noGeoDescription": "Ninguna fila geográfica de Shark coincidió con este modelo.",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de Shark.",
