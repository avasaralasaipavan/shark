export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Shark Data",
  "app.description":
    "Shark kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Shark Data logosu",
  ...
  "header.githubAria": "GitHub'da Shark'a yıldız ver",
  "header.github": "GitHub",
  "header.tryOpenCode": "Shark'u dene",
  ...
  "footer.homeAria": "Shark ana sayfası",
  ...
  "home.topModelsDescription": "Shark genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Shark kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Shark Data",
  "lab.description":
    "Shark'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Shark kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Shark'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Shark kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Shark token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Shark Data",
  "model.description":
    "{{model}} için Shark kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Shark kullanımı görünür.",
  "model.unranked": "Geçen haftaki Shark kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Shark kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Shark kullanımı yok.",
  ...
  "model.overviewDescription": "Son Shark tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Shark kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Shark token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Shark kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Shark oturum yapısı.",
  ...
  "model.noGeoDescription": "Bu modelle eşleşen Shark coğrafi satırı yok.",
  "model.peersDescription": "Son Shark token hacmine göre yakındaki modeller.",
