export const dict = {
  "app.title": "Rankingi użycia modeli AI | Shark Data",
  "app.description":
    "Przeglądaj użycie Shark w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Shark Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Shark na GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Wypróbuj Shark",
  ...
  "footer.homeAria": "Strona główna Shark",
  ...
  "home.topModelsDescription": "Użycie modeli w Shark.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Shark według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Shark Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Shark, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Shark.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Shark",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Shark",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Shark z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Shark Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Shark, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Shark pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Shark z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Shark z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Shark w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Shark, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Shark.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Shark w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Shark w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Shark.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne Shark nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Shark.",
