export const dict = {
  ...
  "desktop.updater.none.message": "Már az Shark legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Shark {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
