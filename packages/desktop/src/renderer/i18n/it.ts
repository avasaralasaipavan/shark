export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Shark è stata scaricata. Vuoi installarla e riavviare l'app?",
