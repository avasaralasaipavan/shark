export const dict = {
  ...
  "desktop.updater.none.message": "Shark-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "Shark-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
