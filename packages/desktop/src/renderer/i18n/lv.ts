export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Shark versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Shark versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
