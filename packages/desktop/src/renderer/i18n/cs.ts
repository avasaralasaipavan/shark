export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Shark. Chcete ji nainstalovat a aplikaci znovu spustit?",
