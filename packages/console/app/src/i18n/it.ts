...
export const dict = {
  ...
  "app.meta.description": "Shark - L'agente di programmazione open source.",

  "home.title": "Shark | L'agente di coding IA open source",
  ...
  "temp.screenshot.caption": "Shark TUI con il tema tokyonight",
  "temp.screenshot.alt": "Shark TUI con tema tokyonight",
  ...
  "home.what.title": "Che cos'è Shark?",
  "home.what.body": "Shark è un agente open source che ti aiuta a scrivere codice nel terminale, IDE o desktop.",
  ...
  "home.growth.body":
    "Con oltre <strong>{{stars}}</strong> stelle su GitHub, <strong>{{contributors}}</strong> contributori e oltre <strong>{{commits}}</strong> commit, Shark è usato e apprezzato da oltre <strong>{{monthlyUsers}}</strong> sviluppatori ogni mese.",
  ...
  "home.privacy.body":
    "Shark non archivia il tuo codice né i dati di contesto, così può operare in ambienti sensibili alla privacy.",
  "home.privacy.learnMore": "Scopri di più su",
  "home.privacy.link": "privacy",

  "home.faq.q1": "Che cos'è Shark?",
  "home.faq.a1":
    "Shark è un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. È disponibile come interfaccia terminale, app desktop o estensione IDE.",
  "home.faq.q2": "Come uso Shark?",
  "home.faq.a2.before": "Il modo più semplice per iniziare è leggere l'",
  "home.faq.a2.link": "introduzione",
  "home.faq.q3": "Mi servono abbonamenti IA extra per usare Shark?",
  "home.faq.a3.p1":
    "Non necessariamente: Shark include un set di modelli gratuiti che puoi usare senza creare un account.",
  "home.faq.a3.p2.beforeZen": "Inoltre, puoi usare modelli popolari per il coding creando un account",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Anche se incoraggiamo gli utenti a usare Zen, Shark funziona anche con i provider più diffusi come OpenAI, Anthropic, xAI, ecc.",
  "home.faq.a3.p4.beforeLocal": "Puoi anche collegare i tuoi",
  "home.faq.a3.p4.localLink": "modelli locali",
  "home.faq.q4": "Posso usare i miei abbonamenti IA esistenti con Shark?",
  "home.faq.a4.p1":
    "Sì, Shark supporta gli abbonamenti dei principali provider. Puoi usare Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Posso usare Shark solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non più! Shark ora è disponibile come app per",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto costa Shark?",
  "home.faq.a6":
    "Shark è gratuito al 100%. Include anche un set di modelli gratuiti. Potrebbero esserci costi aggiuntivi se colleghi altri provider.",
  ...
  "home.faq.q8": "Shark è open source?",
  "home.faq.a8.p1": "Sì, Shark è completamente open source. Il codice sorgente è pubblico su",
  ...
  "home.zenCta.body":
    "Zen ti dà accesso a una selezione di modelli di IA che Shark ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",
  "home.zenCta.link": "Scopri Zen",

  "zen.title": "Shark Zen | Una selezione curata di modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.title": "Accedi a modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.body":
    "Zen ti dà accesso a una selezione di modelli di IA che Shark ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",

  "zen.faq.q1": "Cos'è Shark Zen?",
  "zen.faq.a1":
    "Zen è un set curato di modelli di IA testati e benchmarkati per agenti di coding, creato dal team dietro Shark.",
  ...
  "zen.faq.a3":
    "Zen non è a scopo di lucro. Zen ribalta i costi dei provider di modelli direttamente su di te. Più Zen viene usato, più Shark può negoziare tariffe migliori e passarle a te.",
  ...
  "zen.faq.a4.p3":
    "Per coprire i costi, Shark aggiunge solo una piccola commissione di elaborazione del pagamento di $1.23 per ogni ricarica di saldo da $20.",
  ...
  "zen.faq.a8":
    "Anche se Zen funziona alla grande con Shark, puoi usare Zen con qualsiasi agente. Segui le istruzioni di configurazione nel tuo agente di coding preferito.",
  ...
  "zen.problem.subtitle": "Stiamo risolvendo questo problema per tutti, non solo per gli utenti Shark.",
  ...
  "zen.how.body": "Anche se ti consigliamo di utilizzare Zen con Shark, puoi utilizzare Zen con qualsiasi agente.",
  ...
  "go.title": "Shark Go | Modelli di coding a basso costo per tutti",
  "go.meta.description":
  ...
  "go.problem.body":
    "Ci concentriamo nel portare l'esperienza Shark a quante più persone possibile. Shark Go è un abbonamento a basso costo da $10/mese. Offre limiti generosi e accesso affidabile ai modelli open source più capaci.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go costa $10/mese. Puoi usarlo con Shark o qualsiasi agente.",
  ...
  "zen.api.error.trialEnded":
    "La promozione gratuita di {{model}} è terminata. Puoi continuare a usare il modello abbonandoti a Shark Go - {{link}}",

  "black.meta.title": "Shark Black | Accedi ai migliori modelli di coding al mondo",
  "black.meta.description":
    "Ottieni l'accesso a Claude, GPT, Gemini e altri con i piani di abbonamento Shark Black.",
  "black.hero.title": "Accedi ai migliori modelli di coding al mondo",
  "black.hero.subtitle": "Inclusi Claude, GPT, Gemini e altri",
  "black.title": "Shark Black | Prezzi",
  ...
  "black.subscribe.success.title": "Sei nella lista d'attesa di Shark Black",
  ...
  "workspace.black.subscription.message": "Sei abbonato a Shark Black per ${{plan}} al mese.",
  ...
  "workspace.black.waitlist.joined": "Sei nella waitlist per il piano Shark Black da ${{plan}} al mese.",
  "workspace.black.waitlist.ready": "Siamo pronti per iscriverti al piano Shark Black da ${{plan}} al mese.",
  ...
  "workspace.lite.subscription.message": "Sei abbonato a Shark Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Seleziona "Shark Go" come provider nella tua configurazione opencode per utilizzare i modelli Go.',
  ...
  "workspace.lite.black.message":
    "Attualmente sei abbonato a Shark Black o sei in lista d'attesa. Annulla l'iscrizione prima se desideri passare a Go.",
  "workspace.lite.other.message":
    "Un altro membro in questo workspace è già abbonato a Shark Go. Solo un membro per workspace può abbonarsi.",
  "workspace.lite.promo.description":
    "Shark Go costa {{price}} e offre un accesso affidabile a popolari modelli di coding aperti con generosi limiti di utilizzo.",
  ...
  "download.meta.description": "Scarica Shark per macOS, Windows e Linux",
  "download.hero.title": "Scarica Shark Desktop",
  ...
  "download.section.integrations": "Shark Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Non necessariamente, ma probabilmente. Avrai bisogno di un abbonamento IA se vuoi collegare Shark a un provider a pagamento, sebbene tu possa lavorare con",
  ...
  "download.faq.a3.afterZen": ", Shark funziona con tutti i provider popolari come OpenAI, Anthropic, xAI ecc.",

  "download.faq.a5.p1": "Shark è gratuito al 100%.",
  "download.faq.a5.p2.beforeZen":
    "Eventuali costi aggiuntivi proverranno dal tuo abbonamento a un provider di modelli. Mentre Shark funziona con qualsiasi provider di modelli, raccomandiamo di usare",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "I tuoi dati e informazioni sono archiviati solo quando crei link condivisibili in Shark.",
  "download.faq.a6.p2.beforeShare": "Scopri di più sulle",
  "download.faq.a6.shareLink": "pagine condivise",

  "enterprise.title": "Shark | Soluzioni Enterprise per la tua organizzazione",
  "enterprise.meta.description": "Contatta Shark per soluzioni enterprise",
  "enterprise.hero.title": "Il tuo codice è tuo",
  "enterprise.hero.body1":
    "Shark opera in modo sicuro all'interno della tua organizzazione senza dati o contesto archiviati e senza restrizioni di licenza o rivendicazioni di proprietà. Inizia una prova con il tuo team, poi distribuisci attraverso la tua organizzazione integrandolo con il tuo SSO e gateway IA interno.",
  ...
  "enterprise.faq.q1": "Cos'è Shark Enterprise?",
  "enterprise.faq.a1":
    "Shark Enterprise è per le organizzazioni che vogliono garantire che il loro codice e dati non lascino mai la loro infrastruttura. Può farlo usando una configurazione centralizzata che si integra con il tuo SSO e gateway IA interno.",
  "enterprise.faq.q2": "Come inizio con Shark Enterprise?",
  "enterprise.faq.a2":
    "Inizia semplicemente con una prova interna con il tuo team. Shark per impostazione predefinita non archivia il tuo codice o dati di contesto, rendendo facile iniziare. Poi contattaci per discutere prezzi e opzioni di implementazione.",
  ...
  "enterprise.faq.q4": "I miei dati sono sicuri con Shark Enterprise?",
  "enterprise.faq.a4":
    "Sì. Shark non archivia il tuo codice o dati di contesto. Tutto il trattamento avviene localmente o attraverso chiamate API dirette al tuo provider IA. Con configurazione centrale e integrazione SSO, i tuoi dati rimangono sicuri all'interno dell'infrastruttura della tua organizzazione.",

  "brand.title": "Shark | Brand",
  "brand.meta.description": "Linee guida del brand Shark",
  "brand.heading": "Linee guida del brand",
  "brand.subtitle": "Risorse e asset per aiutarti a lavorare con il brand Shark.",
  "brand.downloadAll": "Scarica tutti gli asset",

  "changelog.title": "Shark | Changelog",
  "changelog.meta.description": "Note di rilascio e changelog Shark",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nuovi aggiornamenti e miglioramenti a Shark",
