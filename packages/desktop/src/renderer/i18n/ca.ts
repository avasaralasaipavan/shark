export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'Shark. Voleu instal·lar-la i reiniciar l'aplicació?",
