export const dict = {
  ...
  "desktop.recovery.loadFailed": "Shark kunde inte läsas in",
  "desktop.recovery.terminated": "Shark-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Shark svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Shark misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Shark-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Shark",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Shark.",
  ...
  "dialog.server.description": "Växla vilken Shark-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Shark i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Shark i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Shark i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Shark i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Shark kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Shark kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Shark igen.",
  ...
  "help.tabs.introduction": "Shark Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Shark ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Shark-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Shark stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Shark innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Shark-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Shark",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Shark ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Shark följer system-, ljus- eller mörktemat",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Shark startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Shark.",
