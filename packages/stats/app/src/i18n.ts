...
const en = {
  "app.title": "AI Model Usage Rankings | Shark Data",
  "app.description":
    "Explore Shark usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Shark Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Shark on GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Try Shark",
  ...
  "home.topModelsDescription": "Usage of models across Shark.",
  ...
  "home.uniqueUsersDescription": "Daily unique Shark users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Shark Data",
  "lab.description":
    "Compare {{lab}} models used in Shark, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Shark usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Shark",
  ...
  "lab.shareOfUsage": "{{share}} of recent Shark usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Shark Data",
  "model.description":
    "View {{model}} Shark usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Shark usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Shark usage",
  "model.ranked": "Ranked #{{rank}} across last week's Shark usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Shark usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Shark usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No Shark geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent Shark token volume.",
