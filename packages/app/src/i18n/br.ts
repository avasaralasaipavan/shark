export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Shark",
  ...
  "desktop.menu.ariaLabel": "Menu do Shark",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Shark",
  "desktop.recovery.terminated": "A janela do Shark foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Shark não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Shark",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Shark não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Shark foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Shark",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Shark.",
  ...
  "dialog.server.description": "Trocar para qual servidor Shark este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Shark em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Shark em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Shark em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Shark",
  "wsl.onboarding.opencodeReadyIn": "O Shark está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Shark está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Shark em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Shark possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Shark não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Shark novamente.",
  ...
  "help.tabs.introduction": "Agora, o Shark Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Shark ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Shark",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Shark ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shark inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Shark dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Shark",
  ...
  "settings.general.row.appearance.description": "Personalize como o Shark aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Shark segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Shark é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Shark iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Shark.",
