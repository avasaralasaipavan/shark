export const dict = {
  ...
  "desktop.updater.none.message": "Shark'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Shark'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
