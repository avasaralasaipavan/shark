import { Brand, brandGlyphs } from "@opencode-ai/brand/env"
...
function wordmark(pad = "") {
  ...
  const glyphs = brandGlyphs()
  return glyphs.left.map((line, index) => {
    const left = draw(line, dim, "\x1b[38;5;235m", "\x1b[48;5;235m")
    const right = draw(glyphs.right[index] ?? "", reset, "\x1b[38;5;238m", "\x1b[48;5;238m")
