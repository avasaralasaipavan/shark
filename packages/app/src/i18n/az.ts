export const dict = {
  ...
  "desktop.recovery.loadFailed": "Shark yüklənə bilmədi",
  "desktop.recovery.terminated": "Shark pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Shark cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Shark quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Shark yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Shark tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Shark-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Shark-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Shark-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Shark serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Shark yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Shark yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Shark yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Shark yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Shark-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Shark-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Shark {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Shark hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Shark-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Shark quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Shark WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Shark bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Shark-u yenidən açın.",
  ...
  "help.tabs.introduction": "Shark Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Shark-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Shark komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Shark hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Shark-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Shark serverini işlət.",
  ...
  "settings.general.row.language.description": "Shark üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Shark-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Shark-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Shark-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Shark açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Shark-un ən son versiyasından istifadə edirsiniz.",
