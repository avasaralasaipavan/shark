export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i Shark është shkarkuar, dëshironi ta instaloni dhe rinisni?",
