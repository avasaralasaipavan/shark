...
export const dict = {
  ...
  "app.meta.description": "Shark - Den open source kodningsagent.",

  "home.title": "Shark | Den open source AI-kodningsagent",
  ...
  "home.what.title": "Hvad er Shark?",
  "home.what.body":
    "Shark er en open source agent, der hjælper dig med at skrive kode i din terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsydere og over <strong>{{commits}}</strong> commits bruges Shark af over <strong>{{monthlyUsers}}</strong> udviklere hver måned.",
  ...
  "home.privacy.body":
    "Shark gemmer ikke din kode eller kontekstdata, så den kan bruges i privatlivsfølsomme miljøer.",
  "home.privacy.learnMore": "Læs mere om",
  "home.privacy.link": "privatliv",

  "home.faq.q1": "Hvad er Shark?",
  "home.faq.a1":
    "Shark er en open source agent, der hjælper dig med at skrive og køre kode med enhver AI-model. Den er tilgængelig som terminal-interface, desktop-app eller IDE-udvidelse.",
  "home.faq.q2": "Hvordan bruger jeg Shark?",
  "home.faq.a2.before": "Den nemmeste måde at komme i gang på er at læse",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Skal jeg have ekstra AI-abonnementer for at bruge Shark?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. Shark kommer med gratis modeller, som du kan bruge uden at oprette en konto.",
  "home.faq.a3.p2.beforeZen": "Derudover kan du bruge populære kodningsmodeller ved at oprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi opfordrer til at bruge Zen, men Shark virker også med populære udbydere som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan endda forbinde dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruge mine eksisterende AI-abonnementer med Shark?",
  "home.faq.a4.p1":
    "Ja. Shark understøtter abonnementer fra alle store udbydere. Du kan bruge Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot.",
  "home.faq.q5": "Kan jeg kun bruge Shark i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke længere! Shark er nu tilgængelig som en app til",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hvad koster Shark?",
  "home.faq.a6":
    "Shark er 100% gratis at bruge. Det kommer også med et sæt gratis modeller. Der kan være ekstra omkostninger, hvis du forbinder en anden udbyder.",
  ...
  "home.faq.q8": "Er Shark open source?",
  "home.faq.a8.p1": "Ja, Shark er fuldt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen giver dig adgang til et håndplukket sæt AI-modeller, som Shark har testet og benchmarked specifikt til kodningsagenter. Du behøver ikke bekymre dig om svingende performance og kvalitet på tværs af udbydere: brug validerede modeller, der virker.",
  "home.zenCta.link": "Læs om Zen",

  "zen.title": "Shark Zen | Et kurateret sæt af pålidelige, optimerede modeller til kodningsagenter",
  "zen.hero.title": "Pålidelige optimerede modeller til kodningsagenter",
  "zen.hero.body":
    "Zen giver dig adgang til et kurateret sæt AI-modeller, som Shark har testet og benchmarked specifikt til kodningsagenter. Du behøver ikke bekymre dig om svingende performance og kvalitet: brug validerede modeller, der virker.",

  "zen.faq.q1": "Hvad er Shark Zen?",
  "zen.faq.a1":
    "Zen er et kurateret sæt AI-modeller testet og benchmarked til kodningsagenter, skabt af teamet bag Shark.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profit. Zen videregiver omkostningerne fra modeludbyderne til dig. Jo mere Zen bruges, desto mere kan Shark forhandle bedre priser og give dem videre til dig.",
  ...
  "zen.faq.a4.p3":
    "For at dække omkostninger tilføjer Shark kun et lille betalingsgebyr på $1.23 per $20 saldo-opfyldning.",
  ...
  "zen.faq.a8":
    "Selvom Zen fungerer godt med Shark, kan du bruge Zen med enhver agent. Følg opsætningsinstruktionerne i din foretrukne kodningsagent.",
  ...
  "zen.problem.subtitle": "Vi løser dette for alle, ikke kun Shark-brugere.",
  ...
  "zen.how.body": "Selvom vi foreslår, at du bruger Zen med Shark, kan du bruge Zen med enhver agent.",
  ...
  "go.title": "Shark Go | Kodningsmodeller til lav pris for alle",
  "go.meta.description":
  ...
  "go.problem.body":
    "Vi fokuserer på at bringe Shark-oplevelsen ud til så mange som muligt. Shark Go er et lavprisabonnement til $10/måned. Det giver generøse grænser og pålidelig adgang til de mest kapable open source-modeller.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go koster $10/måned. Du kan bruge det med Shark eller enhver agent.",
  ...
  "zen.api.error.trialEnded":
    "Den gratis kampagne for {{model}} er afsluttet. Du kan fortsætte med at bruge modellen ved at abonnere på Shark Go - {{link}}",

  "black.meta.title": "Shark Black | Få adgang til verdens bedste kodningsmodeller",
  "black.meta.description": "Få adgang til Claude, GPT, Gemini og mere med Shark Black-abonnementer.",
  ...
  "black.workspace.title": "Shark Black | Vælg workspace",
  ...
  "black.subscribe.success.title": "Du er på Shark Black-ventelisten",
  ...
  "workspace.black.subscription.message": "Du abonnerer på Shark Black for ${{plan}} om måneden.",
  ...
  "workspace.black.waitlist.joined": "Du er på ventelisten for ${{plan}} per måned Shark Black plan.",
  "workspace.black.waitlist.ready": "Vi er klar til at tilmelde dig ${{plan}} per måned Shark Black plan.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Vælg "Shark Go" som udbyder i din opencode-konfiguration for at bruge Go-modeller.',
  ...
  "workspace.lite.black.message":
    "Du abonnerer i øjeblikket på Shark Black eller er på venteliste. Afmeld venligst først, hvis du vil skifte til Go.",
  "workspace.lite.other.message":
    "Et andet medlem i dette workspace abonnerer allerede på Shark Go. Kun ét medlem pr. workspace kan abonnere.",
  "workspace.lite.promo.description":
    "Shark Go koster {{price}} og giver pålidelig adgang til populære åbne kodningsmodeller med generøse brugsgrænser.",
  ...
  "download.meta.description": "Download Shark til macOS, Windows og Linux",
  "download.hero.title": "Download Shark Desktop",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sandsynligvis. Du skal bruge et AI-abonnement hvis du vil forbinde Shark til en betalt udbyder, men du kan arbejde med",
  ...
  "download.faq.a3.afterZen": ", fungerer Shark med alle populære udbydere som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "Shark er 100% gratis at bruge.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra omkostninger kommer fra dit abonnement hos en modeludbyder. Selvom Shark fungerer med enhver modeludbyder, anbefaler vi at bruge",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dine data og oplysninger gemmes kun når du opretter delbare links i Shark.",
  "download.faq.a6.p2.beforeShare": "Læs mere om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "Shark | Enterprise-løsninger til din organisation",
  "enterprise.meta.description": "Kontakt Shark for enterprise-løsninger",
  "enterprise.hero.title": "Din kode er din egen",
  "enterprise.hero.body1":
    "Shark fungerer sikkert inde i din organisation uden at lagre data eller kontekst og uden licensbegrænsninger eller ejerskabskrav. Start en prøveperiode med dit team, og udrul det derefter i hele din organisation ved at integrere det med dit SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hvad er Shark Enterprise?",
  "enterprise.faq.a1":
    "Shark Enterprise er til organisationer, der vil sikre, at deres kode og data aldrig forlader deres infrastruktur. Det kan gøres med en central konfiguration, der integrerer med dit SSO og din interne AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med Shark Enterprise?",
  "enterprise.faq.a2":
    "Start blot med en intern prøveperiode med dit team. Shark gemmer som standard ikke din kode eller kontekstdata, hvilket gør det nemt at komme i gang. Kontakt os derefter for at tale om priser og implementeringsmuligheder.",
  ...
  "enterprise.faq.q4": "Er mine data sikre med Shark Enterprise?",
  "enterprise.faq.a4":
    "Ja. Shark gemmer ikke din kode eller kontekstdata. Al behandling sker lokalt eller via direkte API-kald til din AI-udbyder. Med central konfiguration og SSO-integration forbliver dine data sikre inden for din organisations infrastruktur.",

  "brand.title": "Shark | Brand",
  "brand.meta.description": "Shark brandretningslinjer",
  "brand.heading": "Brandretningslinjer",
  "brand.subtitle": "Ressourcer og assets, der hjælper dig med at arbejde med Shark-brandet.",
  "brand.downloadAll": "Download alle assets",

  "changelog.title": "Shark | Changelog",
  "changelog.meta.description": "Shark versionsnoter og changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nye opdateringer og forbedringer til Shark",
