...
export const dict = {
  ...
  "app.meta.description": "Shark — відкритий агент для програмування.",

  "home.title": "Shark | Відкритий AI-агент для кодування",
  ...
  "temp.screenshot.caption": "Shark TUI з темою tokyonight",
  "temp.screenshot.alt": "Shark TUI з темою tokyonight",
  ...
  "home.what.title": "Що таке Shark?",
  "home.what.body": "Shark — це відкритий агент, який допомагає писати код у терміналі, IDE або на десктопі.",
  ...
  "home.growth.body":
    "З понад <strong>{{stars}}</strong> зірками на GitHub, <strong>{{contributors}}</strong> учасниками та понад <strong>{{commits}}</strong> комітами, Shark використовують понад <strong>{{monthlyUsers}}</strong> розробників щомісяця.",
  ...
  "home.privacy.body":
    "Shark не зберігає ваш код або контекстні дані, тому може працювати в середовищах з чутливими даними.",
  "home.privacy.learnMore": "Дізнатися більше про",
  "home.privacy.link": "конфіденційність",

  "home.faq.q1": "Що таке Shark?",
  "home.faq.a1":
    "Shark — це відкритий агент, який допомагає писати та запускати код з будь-якою AI-моделлю. Доступний як термінальний інтерфейс, десктопний застосунок або розширення IDE.",
  "home.faq.q2": "Як почати користуватися Shark?",
  "home.faq.a2.before": "Найпростіший спосіб почати — прочитати",
  "home.faq.a2.link": "вступ",
  "home.faq.q3": "Чи потрібні додаткові AI-підписки для використання Shark?",
  "home.faq.a3.p1":
    "Не обов'язково, Shark має набір безкоштовних моделей, які можна використовувати без реєстрації.",
  "home.faq.a3.p2.beforeZen":
    "Крім цього, ви можете використовувати будь-які популярні моделі, створивши обліковий запис",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Хоча ми рекомендуємо Zen, Shark також працює з усіма популярними провайдерами, такими як OpenAI, Anthropic, xAI тощо.",
  "home.faq.a3.p4.beforeLocal": "Ви навіть можете підключити свої",
  "home.faq.a3.p4.localLink": "локальні моделі",
  "home.faq.q4": "Чи можу я використовувати свої наявні AI-підписки з Shark?",
  "home.faq.a4.p1":
    "Так, Shark підтримує підписки всіх основних провайдерів. Ви можете використовувати Claude Pro/Max, ChatGPT Plus/Pro або GitHub Copilot.",
  "home.faq.q5": "Чи можна використовувати Shark лише в терміналі?",
  "home.faq.a5.beforeDesktop": "Вже ні! Shark тепер доступний як застосунок для",
  "home.faq.a5.desktop": "десктопа",
  "home.faq.a5.and": "та",
  "home.faq.a5.web": "вебу",
  "home.faq.q6": "Скільки коштує Shark?",
  "home.faq.a6":
    "Shark є 100% безкоштовним. Він також має набір безкоштовних моделей. Додаткові витрати можливі, якщо ви підключите іншого провайдера.",
  ...
  "home.faq.q8": "Чи є Shark відкритим?",
  "home.faq.a8.p1": "Так, Shark повністю відкритий. Вихідний код доступний публічно на",
  ...
  "home.zenCta.body":
    "Zen дає доступ до добірки AI-моделей, які Shark протестував спеціально для агентів кодування. Не турбуйтеся про нестабільну якість — використовуйте перевірені моделі.",
  "home.zenCta.link": "Дізнатися про Zen",

  "zen.title": "Shark Zen | Добірка надійних оптимізованих моделей для агентів кодування",
  "zen.hero.title": "Надійні оптимізовані моделі для агентів кодування",
  "zen.hero.body":
    "Zen дає доступ до добірки AI-моделей, які Shark протестував спеціально для агентів кодування. Не турбуйтеся про нестабільну якість — використовуйте перевірені моделі.",

  "zen.faq.q1": "Що таке Shark Zen?",
  "zen.faq.a1": "Zen — це добірка AI-моделей, протестованих для агентів кодування, створена командою Shark.",
  ...
  "zen.faq.a3":
    "Zen не є прибутковим. Zen передає вам вартість від провайдерів моделей. Чим вище використання Zen, тим кращі ціни Shark може узгодити та передати вам.",
  ...
  "zen.faq.a4.p3":
    "Щоб покрити витрати, Shark додає лише невелику комісію за обробку платежу в розмірі $1.23 за кожне поповнення балансу $20.",
  ...
  "zen.faq.a8":
    "Хоча Zen чудово працює з Shark, ви можете використовувати Zen з будь-яким агентом. Дотримуйтесь інструкцій з налаштування у вашому агенті.",
  ...
  "zen.problem.subtitle": "Ми вирішуємо це для всіх, а не лише для користувачів Shark.",
  ...
  "zen.how.body":
    "Хоча ми пропонуємо використовувати Zen з Shark, ви можете використовувати Zen з будь-яким агентом.",
  ...
  "go.title": "Shark Go | Недорогі моделі кодування для всіх",
  "go.meta.description":
  ...
  "go.problem.body":
    "Ми зосереджені на тому, щоб зробити досвід Shark доступним для якомога більшої кількості людей. Shark Go — це недорога підписка за $10/місяць. Вона надає щедрі ліміти та надійний доступ до найкращих моделей з відкритим кодом.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go коштує $10/місяць. Використовуйте з Shark або будь-яким агентом.",
  ...
  "zen.api.error.trialEnded":
    "Безкоштовна акція для {{model}} закінчилася. Ви можете продовжити використання, підписавшись на Shark Go — {{link}}",

  "black.meta.title": "Shark Black | Доступ до найкращих моделей кодування",
  "black.meta.description": "Отримайте доступ до Claude, GPT, Gemini та інших із планами підписки Shark Black.",
  "black.hero.title": "Доступ до найкращих моделей кодування",
  "black.hero.subtitle": "Включаючи Claude, GPT, Gemini та інші",
  "black.title": "Shark Black | Ціни",
  ...
  "black.workspace.title": "Shark Black | Виберіть робочий простір",
  "black.workspace.selectPlan": "Виберіть робочий простір для цього плану",
  "black.workspace.name": "Робочий простір {{n}}",
  "black.subscribe.title": "Підписатися на Shark Black",
  ...
  "black.subscribe.success.title": "Ви в списку очікування Shark Black",
  ...
  "workspace.black.subscription.message": "Ви підписані на Shark Black за ${{plan}} на місяць.",
  ...
  "workspace.black.waitlist.joined": "Ви в списку очікування на план Shark Black за ${{plan}} на місяць.",
  "workspace.black.waitlist.ready": "Ми готові зареєструвати вас на план Shark Black за ${{plan}} на місяць.",
  ...
  "workspace.lite.subscription.message": "Ви підписані на Shark Go.",
  ...
  "workspace.lite.subscription.selectProvider": 'Виберіть "Shark Go" як провайдера в конфігурації opencode.',
  ...
  "workspace.lite.black.message":
    "Ви вже підписані на Shark Black або в списку очікування. Спочатку скасуйте підписку, якщо хочете перейти на Go.",
  "workspace.lite.other.message": "Інший учасник цього робочого простору вже підписаний на Shark Go.",
  "workspace.lite.promo.description": "Shark Go коштує {{price}} і має щедрі ліміти.",
  ...
  "download.title": "Shark | Завантажити",
  "download.meta.description": "Завантажте Shark для macOS, Windows та Linux",
  "download.hero.title": "Завантажити Shark Desktop",
  "download.hero.subtitle": "Доступно в бета-версії для macOS, Windows та Linux",
  "download.hero.button": "Завантажити для {{os}}",
  "download.section.terminal": "Термінал Shark",
  "download.section.desktop": "Десктоп Shark",
  "download.section.extensions": "Розширення Shark",
  "download.section.integrations": "Інтеграції Shark",
  ...
  "download.faq.a3.afterZen":
    ", Shark працює з усіма популярними провайдерами, такими як OpenAI, Anthropic, xAI тощо.",

  "download.faq.a5.p1": "Shark є 100% безкоштовним.",
  "download.faq.a5.p2.beforeZen":
    "Будь-які додаткові витрати будуть з вашої підписки у провайдера моделі. Ми рекомендуємо",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Ваші дані зберігаються лише при створенні посилань для обміну в Shark.",
  "download.faq.a6.p2.beforeShare": "Дізнайтеся більше про",
  "download.faq.a6.shareLink": "сторінки обміну",

  "enterprise.title": "Shark | Enterprise-рішення для вашої організації",
  "enterprise.meta.description": "Зв'яжіться з Shark для Enterprise-рішень",
  "enterprise.hero.title": "Ваш код належить вам",
  "enterprise.hero.body1":
    "Shark працює безпечно всередині вашої організації без зберігання даних, ліцензійних обмежень. Почніть пробний період із командою, потім розгорніть через SSO та внутрішній AI-шлюз.",
  ...
  "enterprise.faq.q1": "Що таке Shark Enterprise?",
  "enterprise.faq.a1":
    "Shark Enterprise для організацій, які хочуть гарантувати, що код і дані ніколи не залишають їхню інфраструктуру.",
  "enterprise.faq.q2": "Як почати з Shark Enterprise?",
  "enterprise.faq.a2":
    "Почніть із внутрішнього тестування з командою. Shark за замовчуванням не зберігає код. Потім зв'яжіться з нами для обговорення цін.",
  ...
  "enterprise.faq.q4": "Чи безпечні мої дані з Shark Enterprise?",
  "enterprise.faq.a4":
    "Так. Shark не зберігає ваш код або контекст. Вся обробка відбувається локально або через прямі API-виклики.",

  "brand.title": "Shark | Бренд",
  "brand.meta.description": "Рекомендації щодо бренду Shark",
  "brand.heading": "Рекомендації щодо бренду",
  "brand.subtitle": "Ресурси та матеріали для роботи з брендом Shark.",
  "brand.downloadAll": "Завантажити всі матеріали",

  "changelog.title": "Shark | Журнал змін",
  "changelog.meta.description": "Нотатки про випуски та журнал змін Shark",
  "changelog.hero.title": "Журнал змін",
  "changelog.hero.subtitle": "Нові оновлення та покращення Shark",
