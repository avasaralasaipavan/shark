export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Shark wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
