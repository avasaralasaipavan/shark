...
const TIPS: Tip[] = [
  ...
  () => `Use {highlight}${Brand.command} run{/highlight} for non-interactive scripting`,
  () => `Use {highlight}${Brand.command} --continue{/highlight} to resume the last session`,
  () => `Use {highlight}${Brand.command} run -f file.ts{/highlight} to attach files via CLI`,
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  () => `Run {highlight}${Brand.command} serve{/highlight} for headless API access to ${Brand.name}`,
  () => `Use {highlight}${Brand.command} run --attach{/highlight} to connect to a running server`,
  () => `Run {highlight}${Brand.command} upgrade{/highlight} to update to the latest version`,
  ...
  () => `Run {highlight}${Brand.command} github install{/highlight} to set up the GitHub workflow`,
  ...
  () => `Run {highlight}${Brand.command} debug config{/highlight} to troubleshoot configuration`,
  ...
  () => `Use {highlight}/connect{/highlight} with ${Brand.name} Zen for curated, tested models`,
