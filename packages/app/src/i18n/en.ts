...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Shark",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Shark.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Shark Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Shark.",
  ...
  "dialog.server.description": "Switch which Shark server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Shark in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Shark in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Shark in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Shark in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Shark can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Shark could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Shark.",
  ...
  "help.tabs.introduction": "Shark Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Shark ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Shark team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Shark does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Shark includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Shark server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Shark",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Shark looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Shark follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Shark is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Shark launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Shark.",
