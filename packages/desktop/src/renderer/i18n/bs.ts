export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Shark-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Shark-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
