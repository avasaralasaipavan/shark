export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Shark versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
