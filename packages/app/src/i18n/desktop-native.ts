...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Shark failed to load",
  "desktop.recovery.terminated": "Shark window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Shark is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Shark installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Shark update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
