...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Shark",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Shark zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Shark zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Shark zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Shark-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "Shark",
  ...
  "wsl.onboarding.checkingOpencode": "Shark wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Shark in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Shark wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Shark in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Shark in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Shark aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Shark ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Shark ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Shark in {{distro}}.",
  "wsl.onboarding.installOpencode": "Shark installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Shark einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Shark konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Shark erneut.",
  ...
  "toast.update.description": "Eine neue Version von Shark ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Shark-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Shark unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Shark mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Shark enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Shark Desktop",
  ...
  "settings.desktop.wsl.description": "Shark-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Shark ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Shark auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Shark dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Shark anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Shark automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Shark ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Shark wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Shark konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Shark-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Shark reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Shark-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Shark-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Shark Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
