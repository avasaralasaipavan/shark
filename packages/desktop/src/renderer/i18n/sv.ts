export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Shark har laddats ned. Vill du installera den och starta om programmet?",
