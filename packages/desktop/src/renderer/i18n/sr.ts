export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од Shark је преузета, да ли желите да је инсталирате и поново покренете?",
