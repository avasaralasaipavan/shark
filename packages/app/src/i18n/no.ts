...
export const dict = {
  ...
  "desktop.menu.documentation": "Shark-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Shark-meny",
  ...
  "desktop.recovery.loadFailed": "Shark kunne ikke lastes inn",
  "desktop.recovery.terminated": "Shark-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Shark svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Shark mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Shark er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Shark",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Shark.",
  ...
  "dialog.server.description": "Bytt hvilken Shark-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Shark ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Shark-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Shark ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Shark inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Shark-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Shark",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Shark ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Shark skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Shark.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Shark starter",
  ...
  "settings.updates.toast.latest.title": "Shark er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Shark.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Shark i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Shark i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Shark i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Shark i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Shark kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Shark kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Shark på nytt.",
  ...
  "help.tabs.introduction": "Shark Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
