export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Shark-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Shark-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
