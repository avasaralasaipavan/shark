export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Shark",
  ...
  "desktop.menu.ariaLabel": "Shark meni",
  ...
  "desktop.recovery.loadFailed": "Shark se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Shark-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Shark ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Shark-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Shark-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Shark",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Shark-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Shark-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Shark-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Shark server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Shark u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Shark u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Shark u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Shark u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Shark mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Shark nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Shark.",
  ...
  "help.tabs.introduction": "Shark Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Shark-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Shark timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Shark još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Shark uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Shark server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Shark-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Shark izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Shark prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Shark-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Shark pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Shark-a.",
