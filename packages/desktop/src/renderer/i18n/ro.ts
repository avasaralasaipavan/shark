export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Shark a fost descărcată. Vrei să o instalezi și să repornești?",
