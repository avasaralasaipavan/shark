export const dict = {
  ...
  "desktop.recovery.loadFailed": "Shark laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Shark aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Shark ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Shark installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Shark värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Shark",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Shark'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Shark.",
  ...
  "dialog.server.description": "Lülitage, millise Shark serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Shark kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Shark kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Shark värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Shark värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Shark jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Shark asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Shark saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Shark ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Shark.",
  ...
  "help.tabs.introduction": "Shark Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Shark ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Shark meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Shark ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Shark sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Shark Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Shark server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Shark kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Shark teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Shark järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Shark on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Shark käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Shark uusimat versiooni.",
