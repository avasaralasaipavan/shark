export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Shark. ¿Quieres instalarla y reiniciar?",
