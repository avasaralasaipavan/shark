export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av Shark.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av Shark er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
