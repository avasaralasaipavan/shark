export const dict = {
  ...
  "desktop.recovery.loadFailed": "Sharkを読み込めませんでした",
  "desktop.recovery.terminated": "Sharkのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Sharkが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Sharkのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはSharkがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Sharkのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "Sharkが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Sharkで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してSharkで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Sharkで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するSharkサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Sharkを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のSharkを確認中...",
  "wsl.onboarding.updatingOpencode": "Sharkを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のSharkを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のSharkを更新してください。",
  "wsl.onboarding.updateOpencode": "Sharkを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のSharkの準備ができました。",
  "wsl.onboarding.opencodeReady": "Sharkの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にSharkをインストールしてください。",
  "wsl.onboarding.installOpencode": "Sharkをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Sharkがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "SharkでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Sharkをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Shark Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Sharkの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをSharkチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: SharkはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Sharkには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でSharkサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Sharkの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのSharkの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Sharkがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Sharkのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Shark の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Shark は最新バージョンです。",
