...
export const dict = {
  ...
  "notFound.title": "Nicht gefunden | Shark",
  "notFound.heading": "404 - Seite nicht gefunden",
  "notFound.home": "Startseite",
  "notFound.docs": "Dokumentation",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "Shark Logo hell",
  "notFound.logoDarkAlt": "Shark Logo dunkel",
  ...
  "app.meta.description": "Shark - Der Open-Source Coding-Agent.",

  "home.title": "Shark | Der Open-Source AI-Coding-Agent",

  "temp.title": "Shark | Für das Terminal gebauter AI-Coding-Agent",
  ...
  "temp.feature.zen.afterLink": "bereitgestellt von Shark",
  ...
  "temp.screenshot.caption": "Shark TUI mit dem Tokyonight-Theme",
  "temp.screenshot.alt": "Shark TUI mit Tokyonight-Theme",
  "temp.logoLightAlt": "Shark Logo hell",
  "temp.logoDarkAlt": "Shark Logo dunkel",
  ...
  "home.what.title": "Was ist Shark?",
  "home.what.body":
    "Shark ist ein Open-Source-Agent, der dir hilft, Code in deinem Terminal, deiner IDE oder auf dem Desktop zu schreiben.",
  ...
  "home.growth.body":
    "Mit über <strong>{{stars}}</strong> GitHub-Stars, <strong>{{contributors}}</strong> Contributors und über <strong>{{commits}}</strong> Commits wird Shark von über <strong>{{monthlyUsers}}</strong> Entwickler:innen jeden Monat genutzt und geschätzt.",
  ...
  "home.privacy.body":
    "Shark speichert keinen deiner Codes oder Kontextdaten, sodass es in datenschutzsensiblen Umgebungen arbeiten kann.",
  "home.privacy.learnMore": "Erfahre mehr über",
  "home.privacy.link": "Datenschutz",

  "home.faq.q1": "Was ist Shark?",
  "home.faq.a1":
    "Shark ist ein Open-Source-Agent, der dir hilft, Code mit jedem KI-Modell zu schreiben und auszuführen. Er ist als Terminal-Interface, Desktop-App oder IDE-Erweiterung verfügbar.",
  "home.faq.q2": "Wie nutze ich Shark?",
  "home.faq.a2.before": "Der einfachste Weg zu starten ist, die",
  "home.faq.a2.link": "Einführung zu lesen",
  "home.faq.q3": "Brauche ich zusätzliche AI-Abos, um Shark zu nutzen?",
  "home.faq.a3.p1":
    "Nicht unbedingt, Shark kommt mit einer Reihe kostenloser Modelle, die du ohne Account nutzen kannst.",
  ...
  "home.faq.a3.p3":
    "Während wir dazu raten, Zen zu nutzen, funktioniert Shark auch mit allen beliebten Anbietern wie OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Du kannst sogar deine",
  "home.faq.a3.p4.localLink": "lokalen Modelle verbinden",
  "home.faq.q4": "Kann ich meine bestehenden AI-Abos mit Shark nutzen?",
  "home.faq.a4.p1":
    "Ja, Shark unterstützt Abos von allen großen Anbietern. Du kannst deine Claude Pro/Max, ChatGPT Plus/Pro oder GitHub Copilot Abos nutzen.",
  "home.faq.q5": "Kann ich Shark nur im Terminal nutzen?",
  "home.faq.a5.beforeDesktop": "Nicht mehr! Shark ist jetzt als App für",
  "home.faq.a5.desktop": "Desktop",
  "home.faq.a5.and": "und",
  "home.faq.a5.web": "Web verfügbar",
  "home.faq.q6": "Wie viel kostet Shark?",
  "home.faq.a6":
    "Shark ist zu 100% kostenlos. Es enthält auch eine Reihe kostenloser Modelle. Zusätzliche Kosten können entstehen, wenn du andere Anbieter verbindest.",
  ...
  "home.faq.q8": "Ist Shark Open Source?",
  "home.faq.a8.p1": "Ja, Shark ist vollständig Open Source. Der Quellcode ist öffentlich auf",
  ...
  "home.zenCta.body":
    "Zen gibt dir Zugriff auf ein handverlesenes Set an AI-Modellen, die Shark speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität bei verschiedenen Anbietern – nutze validierte Modelle, die funktionieren.",
  "home.zenCta.link": "Erfahre mehr über Zen",

  "zen.title": "Shark Zen | Ein kuratiertes Set zuverlässiger, optimierter Modelle für Coding-Agents",
  "zen.hero.title": "Zuverlässige, optimierte Modelle für Coding-Agents",
  "zen.hero.body":
    "Zen gibt dir Zugriff auf ein kuratiertes Set an AI-Modellen, die Shark speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität – nutze validierte Modelle, die funktionieren.",

  "zen.faq.q1": "Was ist Shark Zen?",
  "zen.faq.a1":
    "Zen ist ein kuratiertes Set an AI-Modellen, getestet und bewertet für Coding-Agents, erstellt vom Team hinter Shark.",
  ...
  "zen.faq.a3":
    "Zen ist nicht gewinnorientiert. Zen gibt die Kosten der Modellanbieter an dich weiter. Je höher die Nutzung von Zen, desto besser kann Shark Preise verhandeln und diese an dich weitergeben.",
  ...
  "zen.faq.a4.p3":
    "Um die Kosten zu decken, fügt Shark nur eine kleine Bearbeitungsgebühr von $1.23 pro $20 Guthabenaufladung hinzu.",
  ...
  "zen.faq.a8":
    "Während Zen großartig mit Shark funktioniert, kannst du Zen mit jedem Agent nutzen. Folge den Einrichtungsanweisungen in deinem bevorzugten Coding-Agent.",
  ...
  "zen.problem.subtitle": "Wir beheben das für alle, nicht nur für Shark-Nutzer.",
  ...
  "zen.how.body": "Während wir dir raten, Zen mit Shark zu nutzen, kannst du Zen mit jedem Agent nutzen.",
  ...
  "go.title": "Shark Go | Kostengünstige Coding-Modelle für alle",
  "go.meta.description":
  ...
  "go.problem.body":
    "Wir konzentrieren uns darauf, die Shark-Erfahrung so vielen Menschen wie möglich zugänglich zu machen. Shark Go ist ein kostengünstiges Abonnement für $10/Monat. Es bietet großzügige Limits und zuverlässigen Zugang zu den leistungsfähigsten Open-Source-Modellen.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go kostet $10/Monat. Du kannst es mit Shark oder jedem Agenten nutzen.",
  ...
  "zen.api.error.trialEnded":
    "Die kostenlose Aktion für {{model}} ist beendet. Du kannst das Modell weiterhin nutzen, indem du Shark Go abonnierst - {{link}}",

  "black.meta.title": "Shark Black | Zugriff auf die weltweit besten Coding-Modelle",
  "black.meta.description": "Erhalte Zugriff auf Claude, GPT, Gemini und mehr mit Shark Black Abos.",
  ...
  "black.title": "Shark Black | Preise",
  ...
  "black.subscribe.success.title": "Du bist auf der Shark Black Warteliste",
  ...
  "workspace.newUser.feature.lockin.body":
    "Nutze Zen mit jedem Coding-Agent und nutze weiterhin andere Anbieter mit Shark, wann immer du willst.",
  ...
  "workspace.newUser.step.login.after": "aus und wähle Shark",
  "workspace.newUser.step.pasteKey": "Füge deinen API Key ein",
  "workspace.newUser.step.models.before": "Starte Shark und führe",
  ...
  "workspace.keys.subtitle": "Verwalte deine API Keys für den Zugriff auf Shark-Dienste.",
  "workspace.keys.create": "API Key erstellen",
  "workspace.keys.placeholder": "Key-Namen eingeben",
  "workspace.keys.empty": "Erstelle einen Shark Gateway API Key",
  ...
  "workspace.black.subscription.message": "Du hast Shark Black für ${{plan}} pro Monat abonniert.",
  ...
  "workspace.black.waitlist.joined": "Du bist auf der Warteliste für den ${{plan}} pro Monat Shark Black Plan.",
  "workspace.black.waitlist.ready": "Wir sind bereit, dich in den ${{plan}} pro Monat Shark Black Plan aufzunehmen.",
  ...
  "workspace.lite.subscription.message": "Du hast Shark Go abonniert.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wähle "Shark Go" als Anbieter in deiner opencode-Konfiguration, um Go-Modelle zu verwenden.',
  ...
  "workspace.lite.black.message":
    "Du hast derzeit Shark Black abonniert oder stehst auf der Warteliste. Bitte kündige zuerst, wenn du zu Go wechseln möchtest.",
  "workspace.lite.other.message":
    "Ein anderes Mitglied in diesem Workspace hat Shark Go bereits abonniert. Nur ein Mitglied pro Workspace kann abonnieren.",
  "workspace.lite.promo.description":
    "Shark Go kostet {{price}} und bietet zuverlässigen Zugang zu beliebten offenen Coding-Modellen mit großzügigen Nutzungslimits.",
  ...
  "download.title": "Shark | Download",
  "download.meta.description": "Lade Shark für macOS, Windows und Linux herunter",
  "download.hero.title": "Shark Desktop herunterladen",
  ...
  "download.section.extensions": "Shark Extensions",
  "download.section.integrations": "Shark Integrationen",
  ...
  "download.faq.a3.beforeLocal":
    "Nicht unbedingt, aber wahrscheinlich. Du brauchst ein AI-Abo, wenn du Shark mit einem bezahlten Anbieter verbinden willst, obwohl du mit",
  ...
  "download.faq.a3.afterZen":
    " zu nutzen, funktioniert Shark mit allen populären Anbietern wie OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "Shark ist 100% kostenlos.",
  "download.faq.a5.p2.beforeZen":
    "Zusätzliche Kosten entstehen durch dein Abo bei einem Modellanbieter. Während Shark mit jedem Modellanbieter funktioniert, empfehlen wir",
  "download.faq.a5.p2.afterZen": " zu nutzen.",

  "download.faq.a6.p1":
    "Deine Daten und Informationen werden nur gespeichert, wenn du teilbare Links in Shark erstellst.",
  "download.faq.a6.p2.beforeShare": "Erfahre mehr über",
  "download.faq.a6.shareLink": "Share-Pages",

  "enterprise.title": "Shark | Enterprise-Lösungen für Ihre Organisation",
  "enterprise.meta.description": "Kontaktieren Sie Shark für Enterprise-Lösungen",
  "enterprise.hero.title": "Ihr Code gehört Ihnen",
  "enterprise.hero.body1":
    "Shark arbeitet sicher innerhalb Ihrer Organisation, ohne dass Daten oder Kontext gespeichert werden und ohne Lizenzbeschränkungen oder Eigentumsansprüche. Starten Sie einen Testlauf mit Ihrem Team, dann rollen Sie es in Ihrer Organisation aus, indem Sie es in Ihr SSO und internes AI-Gateway integrieren.",
  ...
  "enterprise.faq.q1": "Was ist Shark Enterprise?",
  "enterprise.faq.a1":
    "Shark Enterprise ist für Organisationen, die sicherstellen wollen, dass Code und Daten niemals ihre Infrastruktur verlassen. Dies geschieht durch eine zentrale Konfiguration, die in Ihr SSO und internes AI-Gateway integriert wird.",
  "enterprise.faq.q2": "Wie starte ich mit Shark Enterprise?",
  "enterprise.faq.a2":
    "Starten Sie einfach mit einem internen Testlauf mit Ihrem Team. Shark speichert standardmäßig weder Code noch Kontextdaten, was den Einstieg erleichtert. Kontaktieren Sie uns dann, um Preise und Implementierungsoptionen zu besprechen.",
  ...
  "enterprise.faq.q4": "Sind meine Daten mit Shark Enterprise sicher?",
  "enterprise.faq.a4":
    "Ja. Shark speichert weder Ihren Code noch Kontextdaten. Alle Verarbeitungen finden lokal oder über direkte API-Aufrufe an Ihren AI-Anbieter statt. Mit zentraler Konfiguration und SSO-Integration bleiben Ihre Daten sicher innerhalb der Infrastruktur Ihrer Organisation.",

  "brand.title": "Shark | Marke",
  "brand.meta.description": "Shark Markenrichtlinien",
  "brand.heading": "Markenrichtlinien",
  "brand.subtitle": "Ressourcen und Assets, die dir helfen, mit der Shark-Marke zu arbeiten.",
  "brand.downloadAll": "Alle Assets herunterladen",

  "changelog.title": "Shark | Changelog",
  "changelog.meta.description": "Shark Release Notes und Changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Neue Updates und Verbesserungen für Shark",
