...
export const dict = {
  ...
  "app.meta.description": "Shark - AI-агент с открытым кодом для программирования.",

  "home.title": "Shark | AI-агент с открытым кодом для программирования",
  ...
  "temp.screenshot.caption": "Shark TUI с темой tokyonight",
  "temp.screenshot.alt": "Shark TUI с темой tokyonight",
  ...
  "home.what.title": "Что такое Shark?",
  "home.what.body":
    "Shark — это агент с открытым исходным кодом, который помогает писать код в терминале, IDE или на десктопе.",
  ...
  "home.growth.body":
    "С более чем <strong>{{stars}}</strong> звезд на GitHub, <strong>{{contributors}}</strong> контрибьюторов и <strong>{{commits}}</strong> коммитов, Shark доверяют более <strong>{{monthlyUsers}}</strong> разработчиков ежемесячно.",
  ...
  "home.privacy.body":
    "Shark не хранит ваш код или контекстные данные, поэтому он может работать в средах, чувствительных к приватности.",
  "home.privacy.learnMore": "Подробнее о",
  "home.privacy.link": "приватности",

  "home.faq.q1": "Что такое Shark?",
  "home.faq.a1":
    "Shark — это агент с открытым исходным кодом, который помогает писать и запускать код с любой AI-моделью. Доступен как терминальный интерфейс, десктопное приложение или расширение для IDE.",
  "home.faq.q2": "Как использовать Shark?",
  "home.faq.a2.before": "Проще всего начать с чтения",
  "home.faq.a2.link": "введения",
  "home.faq.q3": "Нужны ли дополнительные подписки на AI для использования Shark?",
  "home.faq.a3.p1":
    "Не обязательно, Shark поставляется с набором бесплатных моделей, которые можно использовать без создания аккаунта.",
  "home.faq.a3.p2.beforeZen":
    "Помимо этого, вы можете использовать любые популярные модели для кодинга, создав аккаунт",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Хотя мы рекомендуем использовать Zen, Shark также работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",
  "home.faq.a3.p4.beforeLocal": "Вы даже можете подключить ваши",
  "home.faq.a3.p4.localLink": "локальные модели",
  "home.faq.q4": "Могу ли я использовать мои существующие AI-подписки с Shark?",
  "home.faq.a4.p1":
    "Да, Shark поддерживает подписки всех основных провайдеров. Вы можете использовать ваши подписки Claude Pro/Max, ChatGPT Plus/Pro или GitHub Copilot.",
  "home.faq.q5": "Можно ли использовать Shark только в терминале?",
  "home.faq.a5.beforeDesktop": "Больше нет! Shark теперь доступен как приложение для",
  "home.faq.a5.desktop": "десктопа",
  "home.faq.a5.and": "и",
  "home.faq.a5.web": "веба",
  "home.faq.q6": "Сколько стоит Shark?",
  "home.faq.a6":
    "Shark на 100% бесплатен. Он также включает набор бесплатных моделей. Дополнительные расходы могут возникнуть, если вы подключите другого провайдера.",
  ...
  "home.faq.q8": "Shark — это open source?",
  "home.faq.a8.p1": "Да, Shark полностью open source. Исходный код доступен публично на",
  "home.faq.a8.p2": "под",
  ...
  "home.zenCta.body":
    "Zen дает доступ к отобранному набору AI-моделей, которые Shark протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве разных провайдеров, используйте проверенные модели, которые работают.",
  "home.zenCta.link": "Узнать о Zen",

  "zen.title": "Shark Zen | Набор надежных оптимизированных моделей для кодинг-агентов",
  "zen.hero.title": "Надежные оптимизированные модели для кодинг-агентов",
  "zen.hero.body":
    "Zen дает доступ к отобранному набору AI-моделей, которые Shark протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве, используйте проверенные модели, которые работают.",

  "zen.faq.q1": "Что такое Shark Zen?",
  "zen.faq.a1":
    "Zen — это отобранный набор AI-моделей, протестированных и проверенных для кодинг-агентов командой, стоящей за Shark.",
  ...
  "zen.faq.a3":
    "Zen — некоммерческий проект. Zen транслирует расходы от провайдеров моделей вам. Чем больше использование Zen, тем лучшие тарифы Shark может согласовать и передать вам.",
  ...
  "zen.faq.a4.p3":
    "Для покрытия расходов Shark добавляет лишь небольшую комиссию за обработку платежа в размере $1.23 при пополнении баланса на $20.",
  ...
  "zen.faq.a8":
    "Хотя Zen отлично работает с Shark, вы можете использовать Zen с любым агентом. Следуйте инструкциям по настройке в вашем любимом агенте.",
  ...
  "zen.problem.subtitle": "Мы исправляем это для всех, а не только для пользователей Shark.",
  ...
  "zen.how.body": "Хотя мы предлагаем использовать Zen с Shark, вы можете использовать его с любым агентом.",
  ...
  "go.title": "Shark Go | Недорогие модели для кодинга для всех",
  "go.meta.description":
  ...
  "go.problem.body":
    "Мы стремимся сделать Shark доступным для как можно большего числа людей. Shark Go - это недорогая подписка за $10/месяц. Она предоставляет щедрые лимиты и надежный доступ к самым мощным моделям с открытым исходным кодом.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go стоит $10/месяц. Вы можете использовать его с Shark или любым агентом.",
  ...
  "zen.api.error.trialEnded":
    "Бесплатная акция для {{model}} завершена. Вы можете продолжить использование модели, подписавшись на Shark Go - {{link}}",

  "black.meta.title": "Shark Black | Доступ к лучшим моделям для кодинга в мире",
  "black.meta.description": "Получите доступ к Claude, GPT, Gemini и другим моделям с подпиской Shark Black.",
  "black.hero.title": "Доступ к лучшим моделям для кодинга в мире",
  "black.hero.subtitle": "Включая Claude, GPT, Gemini и другие",
  "black.title": "Shark Black | Цены",
  ...
  "black.subscribe.success.title": "Вы в списке ожидания Shark Black",
  ...
  "workspace.black.subscription.message": "Вы подписаны на Shark Black за ${{plan}} в месяц.",
  ...
  "workspace.black.waitlist.joined": "Вы в списке ожидания плана Shark Black за ${{plan}} в месяц.",
  "workspace.black.waitlist.ready": "Мы готовы подключить вас к плану Shark Black за ${{plan}} в месяц.",
  ...
  "workspace.lite.subscription.message": "Вы подписаны на Shark Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Выберите "Shark Go" в качестве провайдера в настройках opencode для использования моделей Go.',
  ...
  "workspace.lite.black.message":
    "Вы подписаны на Shark Black или находитесь в списке ожидания. Пожалуйста, сначала отмените подписку, если хотите перейти на Go.",
  "workspace.lite.other.message":
    "Другой участник в этом рабочем пространстве уже подписан на Shark Go. Только один участник в рабочем пространстве может оформить подписку.",
  "workspace.lite.promo.description":
    "Shark Go стоит {{price}} и предоставляет надежный доступ к популярным открытым моделям кодирования с щедрыми лимитами использования.",
  ...
  "download.title": "Shark | Скачать",
  "download.meta.description": "Скачать Shark для macOS, Windows и Linux",
  "download.hero.title": "Скачать Shark Desktop",
  ...
  "download.section.extensions": "Расширения Shark",
  "download.section.integrations": "Интеграции Shark",
  ...
  "download.faq.a3.beforeLocal":
    "Не обязательно, но возможно. Вам понадобится AI подписка, если вы хотите подключить Shark к платному провайдеру, хотя вы можете работать с",
  ...
  "download.faq.a3.afterZen":
    ", Shark работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",

  "download.faq.a5.p1": "Shark на 100% бесплатен.",
  "download.faq.a5.p2.beforeZen":
    "Любые дополнительные расходы будут связаны с вашей подпиской у провайдера моделей. Хотя Shark работает с любым провайдером моделей, мы рекомендуем использовать",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Ваши данные и информация сохраняются только при создании ссылок для шеринга в Shark.",
  "download.faq.a6.p2.beforeShare": "Подробнее о",
  "download.faq.a6.shareLink": "страницах шеринга",

  "enterprise.title": "Shark | Корпоративные решения для вашей организации",
  "enterprise.meta.description": "Свяжитесь с Shark для корпоративных решений",
  "enterprise.hero.title": "Ваш код принадлежит вам",
  "enterprise.hero.body1":
    "Shark безопасно работает внутри вашей организации: не хранит данные и контекст, без лицензионных ограничений и претензий на собственность. Начните пробный период с командой, затем разверните по всей организации, интегрировав с SSO и внутренним AI-шлюзом.",
  ...
  "enterprise.faq.q1": "Что такое Shark Enterprise?",
  "enterprise.faq.a1":
    "Shark Enterprise предназначен для организаций, которые хотят гарантировать, что их код и данные никогда не покинут их инфраструктуру. Это достигается за счет централизованной конфигурации, интегрированной с вашим SSO и внутренним AI-шлюзом.",
  "enterprise.faq.q2": "Как начать работу с Shark Enterprise?",
  "enterprise.faq.a2":
    "Просто начните с внутреннего триала с вашей командой. Shark по умолчанию не хранит ваш код или контекстные данные, поэтому начать легко. Затем свяжитесь с нами, чтобы обсудить цены и варианты внедрения.",
  ...
  "enterprise.faq.q4": "Безопасны ли мои данные с Shark Enterprise?",
  "enterprise.faq.a4":
    "Да. Shark не хранит ваш код или контекстные данные. Вся обработка происходит локально или через прямые вызовы API к вашему AI-провайдеру. Благодаря централизованной конфигурации и интеграции SSO ваши данные остаются защищенными внутри инфраструктуры вашей организации.",

  "brand.title": "Shark | Бренд",
  "brand.meta.description": "Гайдлайны бренда Shark",
  "brand.heading": "Гайдлайны бренда",
  "brand.subtitle": "Ресурсы и активы, которые помогут вам работать с брендом Shark.",
  "brand.downloadAll": "Скачать все ресурсы",

  "changelog.title": "Shark | Список изменений",
  "changelog.meta.description": "Примечания к релизам и список изменений Shark",
  "changelog.hero.title": "Список изменений",
  "changelog.hero.subtitle": "Новые обновления и улучшения Shark",
