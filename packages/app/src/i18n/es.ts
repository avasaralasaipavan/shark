export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Shark",
  ...
  "desktop.menu.ariaLabel": "Menú de Shark",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Shark",
  "desktop.recovery.terminated": "La ventana de Shark se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Shark no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Shark",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Shark finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Shark",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Shark.",
  ...
  "dialog.server.description": "Cambiar el servidor de Shark al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Shark en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Shark en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Shark en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Shark en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Shark pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Shark no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Shark.",
  ...
  "help.tabs.introduction": "Shark Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Shark ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Shark",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Shark aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shark incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Shark dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Shark",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Shark en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Shark sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Shark.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Shark",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Shark.",
