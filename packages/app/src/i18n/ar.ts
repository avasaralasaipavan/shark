export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Shark",
  "desktop.recovery.terminated": "توقفت نافذة Shark بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Shark لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Shark",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Shark، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Shark",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك Shark Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Shark.",
  ...
  "dialog.server.description": "تبديل خادم Shark الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Shark...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Shark في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Shark...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Shark في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Shark في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Shark في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Shark من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Shark التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Shark.",
  ...
  "help.tabs.introduction": "أصبح Shark Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Shark ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Shark",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Shark لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Shark نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Shark داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Shark",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Shark على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Shark يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Shark.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Shark",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Shark.",
