export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Shark",
  ...
  "desktop.menu.ariaLabel": "Meniu Shark",
  ...
  "desktop.recovery.loadFailed": "Shark nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Shark s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Shark nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Shark a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Shark s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Shark",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Shark.",
  ...
  "dialog.server.description": "Schimbă serverul Shark la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Shark în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Shark în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează Shark în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează Shark în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Shark să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Shark nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Shark.",
  ...
  "help.tabs.introduction": "Shark Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Shark ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Shark",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Shark nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shark include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Shark în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Shark",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Shark pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Shark urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Shark.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Shark",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Shark.",
