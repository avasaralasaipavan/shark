...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Shark yüklenemedi",
  "desktop.recovery.terminated": "Shark penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Shark yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Shark kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Shark güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Shark tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Shark'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Shark'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Shark'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Shark sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Shark kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Shark kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Shark güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Shark güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Shark'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Shark'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Shark hazır.",
  "wsl.onboarding.opencodeReady": "Shark hazır.",
  "wsl.onboarding.installOpencodeIn": "Shark'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Shark'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Shark'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Shark bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Shark'u tekrar açın.",
  ...
  "help.tabs.introduction": "Shark Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Shark'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Shark ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Shark henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Shark ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Shark Masaüstü",
  ...
  "settings.desktop.wsl.description": "Shark sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Shark'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Shark'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Shark'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Shark'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Shark başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Shark'un en son sürümünü kullanıyorsunuz.",
