export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Shark er lastet ned. Vil du installere den og starte på nytt?",
