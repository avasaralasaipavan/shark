export const dict = {
  ...
  "desktop.menu.documentation": "Shark-documentatie",
  ...
  "desktop.recovery.loadFailed": "Shark kan niet worden geladen",
  "desktop.recovery.terminated": "Het Shark-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Shark reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Shark is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Shark-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Shark",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Shark te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Shark te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Shark te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Shark-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Shark controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Shark controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Shark bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Shark bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Shark bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Shark bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Shark is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Shark in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Shark een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Shark kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Shark opnieuw.",
  ...
  "help.tabs.introduction": "Shark Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Shark ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Shark-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Shark ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Shark bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Shark-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Shark",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Shark eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Shark het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Shark aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Shark wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Shark is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Shark.",
