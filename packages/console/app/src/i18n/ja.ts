...
export const dict = {
  ...
  "app.meta.description": "Shark - オープンソースのコーディングエージェント。",

  "home.title": "Shark | オープンソースのAIコーディングエージェント",

  "temp.title": "Shark | ターミナル向けに構築されたAIコーディングエージェント",
  ...
  "temp.feature.zen.beforeLink": "Sharkが提供する",
  ...
  "temp.screenshot.caption": "tokyonight テーマを使用した Shark TUI",
  "temp.screenshot.alt": "tokyonight テーマの Shark TUI",
  ...
  "home.what.title": "Sharkとは？",
  "home.what.body":
    "Sharkは、ターミナル、IDE、またはデスクトップでのコード作成を支援するオープンソースのエージェントです。",
  ...
  "home.privacy.body":
    "Sharkはコードやコンテキストデータを一切保存しないため、プライバシーが重視される環境でも利用できます。",
  "home.privacy.learnMore": "詳しくは",
  "home.privacy.link": "プライバシー",

  "home.faq.q1": "Sharkとは？",
  "home.faq.a1":
    "Sharkは、任意のAIモデルでコードの作成・実行を支援するオープンソースのエージェントです。ターミナルベースのインターフェース、デスクトップアプリ、IDE拡張として利用できます。",
  "home.faq.q2": "Sharkの使い方は？",
  "home.faq.a2.before": "最も簡単な始め方は",
  "home.faq.a2.link": "イントロを読む",
  "home.faq.q3": "Sharkには追加のAIサブスクリプションが必要ですか？",
  "home.faq.a3.p1": "必ずしも必要ではありません。Sharkには、アカウント不要で使える無料モデルが含まれています。",
  "home.faq.a3.p2.beforeZen": "これらに加えて、",
  "home.faq.a3.p2.afterZen": " アカウントを作成することで、人気のコーディングモデルを利用できます。",
  "home.faq.a3.p3":
    "Zenの利用を推奨していますが、SharkはOpenAI、Anthropic、xAIなどの主要プロバイダーにも対応しています。",
  "home.faq.a3.p4.beforeLocal": "さらに、",
  "home.faq.a3.p4.localLink": "ローカルモデル",
  "home.faq.q4": "既存のAIサブスクリプションをSharkで使えますか？",
  "home.faq.a4.p1":
    "はい、Sharkは主要プロバイダーのサブスクリプションプランに対応しています。Claude Pro/Max、ChatGPT Plus/Pro、GitHub Copilotのサブスクリプションを利用できます。",
  "home.faq.q5": "ターミナルだけで使えますか？",
  "home.faq.a5.beforeDesktop": "もう違います！Sharkは今は",
  "home.faq.a5.desktop": "デスクトップ",
  "home.faq.a5.and": "と",
  "home.faq.a5.web": "ウェブ",
  "home.faq.q6": "Sharkの価格は？",
  "home.faq.a6":
    "Sharkは100%無料で使えます。無料モデルも含まれています。他のプロバイダーに接続する場合は追加費用が発生することがあります。",
  ...
  "home.faq.q8": "Sharkはオープンソースですか？",
  "home.faq.a8.p1": "はい、Sharkは完全にオープンソースです。ソースコードは",
  "home.faq.a8.p2": "の",
  ...
  "home.zenCta.body":
    "Zenは、Sharkがコーディングエージェント向けにテスト・ベンチマーク済みのAIモデルを厳選して提供します。プロバイダー間の性能・品質のブレを気にせず、検証済みのモデルを利用できます。",
  "home.zenCta.link": "Zenについて知る",

  "zen.title": "Shark Zen | コーディングエージェント向けの信頼できる最適化モデル",
  "zen.hero.title": "コーディングエージェント向けの信頼できる最適化モデル",
  "zen.hero.body":
    "Zenは、Sharkがコーディングエージェント向けにテスト・ベンチマーク済みのAIモデルを厳選して提供します。プロバイダー間の性能・品質のブレを気にせず、検証済みのモデルを利用できます。",

  "zen.faq.q1": "Shark Zenとは？",
  "zen.faq.a1":
    "Zenは、Sharkのチームが作成した、コーディングエージェント向けにテスト・ベンチマークされたAIモデルの厳選セットです。",
  ...
  "zen.faq.a3":
    "Zenは営利目的ではありません。Zenはモデル提供元のコストをそのままあなたに渡します。Zenの利用が増えるほど、Sharkはより良いレートを交渉し、その分をあなたに還元できます。",
  "zen.faq.q4": "Zenの料金は？",
  ...
  "zen.faq.a4.p3": "コストを賄うために、Sharkは$20の残高チャージあたり$1.23の小さな決済手数料のみを追加します。",
  ...
  "zen.faq.a8":
    "ZenはSharkとの相性が良いですが、どのエージェントでもZenを利用できます。お使いのコーディングエージェントのセットアップ手順に従ってください。",
  ...
  "zen.problem.subtitle": "Sharkユーザーだけでなく、すべての人を対象にこの問題を修正しています。",
  ...
  "zen.how.body": "ZenをSharkとともに使用することをお勧めしますが、Zenはどのエージェントでも使用できます。",
  ...
  "go.title": "Shark Go | すべての人のための低価格なコーディングモデル",
  "go.meta.description":
  ...
  "go.problem.body":
    "私たちはSharkの体験をできるだけ多くの人に届けることに注力しています。Shark Goは月額$10の低価格なサブスクリプションです。ゆとりある上限と、最も高性能なオープンソースモデルへの信頼できるアクセスを提供します。",
  "go.problem.subtitle": " ",
  ...
  "go.how.title": "Goの仕組み",
  "go.how.body": "Goは月額$10です。Sharkまたは任意のエージェントで使えます。",
  ...
  "zen.api.error.trialEnded":
    "{{model}} の無料プロモーションは終了しました。Shark Go を購読するとモデルを引き続き使用できます - {{link}}",

  "black.meta.title": "Shark Black | 世界最高峰のコーディングモデルすべてにアクセス",
  "black.meta.description": "Shark Black サブスクリプションプランで、Claude、GPT、Gemini などにアクセス。",
  "black.hero.title": "世界最高峰のコーディングモデルすべてにアクセス",
  "black.hero.subtitle": "Claude、GPT、Gemini などを含む",
  "black.title": "Shark Black | 料金",
  ...
  "black.workspace.title": "Shark Black | ワークスペースの選択",
  "black.workspace.selectPlan": "このプランのワークスペースを選択してください",
  "black.workspace.name": "ワークスペース {{n}}",
  "black.subscribe.title": "Shark Black を購読する",
  ...
  "black.subscribe.success.title": "Shark Black ウェイトリストに登録されました",
  ...
  "workspace.newUser.feature.lockin.body":
    "任意のコーディングエージェントでZenを使用でき、必要に応じていつでもSharkを備えた他のプロバイダーを使用し続けることができます。",
  ...
  "workspace.newUser.step.login.after": "してSharkを選択",
  "workspace.newUser.step.pasteKey": "APIキーを貼り付け",
  "workspace.newUser.step.models.before": "Sharkを起動し実行",
  ...
  "workspace.keys.subtitle": "SharkサービスにアクセスするためのAPIキーを管理します。",
  "workspace.keys.create": "APIキーの作成",
  "workspace.keys.placeholder": "キー名を入力してください",
  "workspace.keys.empty": "SharkゲートウェイAPIキーを作成する",
  ...
  "workspace.black.subscription.message": "あなたは Shark Black を月額 ${{plan}} で購読しています。",
  ...
  "workspace.black.waitlist.joined":
    "あなたは月額 ${{plan}} の Shark Black プランのウェイトリストに登録されています。",
  "workspace.black.waitlist.ready": "月額 ${{plan}} の Shark Black プランに登録する準備ができました。",
  ...
  "workspace.lite.subscription.message": "あなたは Shark Go を購読しています。",
  ...
  "workspace.lite.subscription.selectProvider":
    "Go モデルを使用するには、opencode の設定で「Shark Go」をプロバイダーとして選択してください。",
  ...
  "workspace.lite.black.message":
    "現在 Shark Black を購読中、またはウェイティングリストに登録されています。Go に切り替える場合は、先に登録を解除してください。",
  "workspace.lite.other.message":
    "このワークスペースの別のメンバーが既に Shark Go を購読しています。ワークスペースにつき1人のメンバーのみが購読できます。",
  "workspace.lite.promo.description":
    "Shark Goは{{price}}で、人気の高いオープンコーディングモデルへの安定したアクセスと余裕のある利用枠を提供します。",
  ...
  "download.title": "Shark | ダウンロード",
  "download.meta.description": "Shark を macOS、Windows、Linux 向けにダウンロード",
  "download.hero.title": "Shark デスクトップ版をダウンロード",
  ...
  "download.faq.a3.beforeLocal":
    "必ずしもそうではありませんが、おそらく必要です。Sharkを有料プロバイダーに接続したい場合はAIサブスクリプションが必要ですが、",
  "download.faq.a3.localLink": "ローカルモデル",
  "download.faq.a3.afterLocal.beforeZen": "であれば無料で利用できます。ユーザーには",
  "download.faq.a3.afterZen":
    "の利用をお勧めしていますが、SharkはOpenAI、Anthropic、xAIなどの主要なプロバイダーに対応しています。",

  "download.faq.a5.p1": "Sharkは100%無料で利用できます。",
  "download.faq.a5.p2.beforeZen":
    "追加コストはモデルプロバイダーのサブスクリプションから発生します。Sharkはどのモデルプロバイダーでも利用できますが、",
  "download.faq.a5.p2.afterZen": "の利用をおすすめします。",

  "download.faq.a6.p1": "あなたのデータと情報は、Sharkで共有リンクを作成したときにのみ保存されます。",
  "download.faq.a6.p2.beforeShare": "詳しくは",
  "download.faq.a6.shareLink": "共有ページ",

  "enterprise.title": "Shark | 組織向けエンタープライズソリューション",
  "enterprise.meta.description": "エンタープライズソリューションについてSharkに問い合わせる",
  "enterprise.hero.title": "あなたのコードはあなたのもの",
  "enterprise.hero.body1":
    "Sharkは、データやコンテキストを一切保存せず、ライセンス制限や所有権の主張もなく、組織内で安全に動作します。チームでのトライアルから始め、SSOや社内AIゲートウェイと統合して組織全体に展開できます。",
  ...
  "enterprise.faq.q1": "Shark Enterpriseとは？",
  "enterprise.faq.a1":
    "Shark Enterpriseは、コードとデータが決してインフラの外に出ないことを保証したい組織向けです。SSOや社内AIゲートウェイと統合する集中設定を使用することでこれを実現します。",
  "enterprise.faq.q2": "Shark Enterpriseを始めるには？",
  "enterprise.faq.a2":
    "まずはチームでの社内トライアルから始めてください。Sharkはデフォルトでコードやコンテキストデータを保存しないため、簡単に始められます。その後、価格や導入オプションについてお問い合わせください。",
  ...
  "enterprise.faq.q4": "Shark Enterpriseでデータは安全ですか？",
  "enterprise.faq.a4":
    "はい。Sharkはコードやコンテキストデータを保存しません。すべての処理はローカル、またはAIプロバイダーへの直接API呼び出しを通じて行われます。集中設定とSSO統合により、データは組織のインフラ内で安全に保たれます。",

  "brand.title": "Shark | ブランド",
  "brand.meta.description": "Shark ブランドガイドライン",
  "brand.heading": "ブランドガイドライン",
  "brand.subtitle": "Sharkブランドを扱うためのリソースと素材です。",
  "brand.downloadAll": "すべての素材をダウンロード",

  "changelog.title": "Shark | 変更履歴",
  "changelog.meta.description": "Shark リリースノートと変更履歴",
  "changelog.hero.title": "変更履歴",
  "changelog.hero.subtitle": "Sharkの新しいアップデートと改善",
