...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Shark",
  "Shark-glugganum var óvænt lokað",
  "Shark svarar ekki",
  ...
  "Shark er ekki uppsett í {{distro}}",
  "Uppfærslu Shark lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Shark",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Shark.",
  ...
  "dialog.server.description": "Skiptu um hvaða Shark miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar Shark í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Shark í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Shark í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Shark í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Shark getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Shark gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Shark aftur.",
  ...
  "help.tabs.introduction": "Shark Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Shark ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Shark teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Shark styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Shark inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Shark skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Shark netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Shark",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Shark lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Shark fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Shark er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Shark ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Shark.",
