export const dict = {
  ...
  "desktop.menu.documentation": "Shark Skjøl",
  ...
  "desktop.menu.ariaLabel": "Shark valmynd",
  ...
  "desktop.recovery.loadFailed": "Shark miseydnaðist at heinta",
  "desktop.recovery.terminated": "Shark vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Shark svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "Shark uppsetingin miseydnaðist",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Shark dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Shark",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Shark.",
  ...
  "dialog.server.description": "Skift hvønn Shark ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna Shark í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring Shark í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør Shark í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set Shark upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Shark kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Shark kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Shark aftur.",
  ...
  "help.tabs.introduction": "Shark Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Shark ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Shark toymið",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Shark stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Shark inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Shark Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Shark ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Shark",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Shark sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Shark fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Shark er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Shark byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Shark.",
