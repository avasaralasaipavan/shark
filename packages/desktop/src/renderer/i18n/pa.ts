export const dict = {
  ...
  "desktop.updater.none.message": "تسی پہلے ای Shark دا تازہ ترین ورژن استعمال کر رئے او",
  ...
  "desktop.updater.downloaded.prompt":
    "Shark دا ورژن {{version}} ڈاؤن لوڈ کر دتا گیا اے، کی تسی اینوں انسٹال کرنا تے دوبارہ لانچ کرنا چاہندے او؟",
