export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Shark",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Shark telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
