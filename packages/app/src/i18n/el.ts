export const dict = {
  ...
  "desktop.menu.documentation": "Shark Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Shark μενού",
  ...
  "desktop.recovery.loadFailed": "Shark απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Shark το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Shark δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Shark η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Shark η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Shark",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Shark.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Shark συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Shark...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Shark σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Shark...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Shark σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Shark σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Shark στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Shark να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Shark δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Shark.",
  ...
  "help.tabs.introduction": "Shark Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Shark ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Shark",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Shark δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shark περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Shark Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Shark μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Shark",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Shark στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Shark ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Shark.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Shark",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Shark.",
