export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Shark Data",
  "app.description":
    "Explore o uso do Shark em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Shark Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Shark no GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Experimente o Shark",
  ...
  "footer.homeAria": "Início do Shark",
  ...
  "modal.title": "Newsletter do Shark",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Shark.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Shark por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Shark Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Shark, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Shark.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Shark",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Shark",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Shark nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Shark Data",
  "model.description":
    "Veja dados de uso de {{model}} no Shark, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Shark aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Shark da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Shark da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Shark na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Shark, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Shark.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Shark na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Shark na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Shark.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do Shark correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Shark.",
