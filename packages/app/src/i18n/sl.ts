export const dict = {
  ...
  "desktop.menu.documentation": "Shark Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Shark ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Shark se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Shark se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Shark ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Shark ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Shark je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Shark",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Shark.",
  ...
  "provider.connect.opencodeZen.line1":
    "Shark Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Shark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Shark.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Shark se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Shark ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Shark v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Shark ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Shark v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Shark v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Shark",
  "wsl.onboarding.opencodeReadyIn": "Shark je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Shark je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Shark v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Shark",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Shark ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Shark doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Shark ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Shark.",
  ...
  "help.tabs.introduction": "Shark Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Shark ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Shark",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Shark še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shark vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Shark znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Shark",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Shark izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Shark sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Shark.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Shark",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Shark.",
